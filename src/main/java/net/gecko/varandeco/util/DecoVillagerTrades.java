...
public class DecoVillagerTrades {
    public static final ResourceKey<VillagerTrade> DECO_WANDERING_TRADER_EMERALD_PUFFY_DANELION =
            resourceKey("wandering_trader/emerald_puffy");
    ...
    public static Holder<VillagerTrade> bootstrap(final BootstrapContext<VillagerTrade> context) {
        ...
        TradeOfferHelper.registerWanderingTraderOffers(factories -> {
            factories.addOffersToPool(Identifier.parse("sell_special_items"),
                    (world,entity, random) -> new MerchantOffer(
                            new ItemCost(Items.EMERALD, 3),
