...
public class DecoBlockEntities {
    ...
    public static BlockEntityType<@NotNull BlackstoneBlastFurnaceBlockEntity> BLACKSTONE_BLAST_FURNACE_BE;
    ...
    public static void registerBlockEntities(){
        ...
        DEEPSLATE_FURNACE_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco.MOD_ID + "deepslate_furnace_be"),
        ...
        BLACKSTONE_FURNACE_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "blackstone_furnace_be"),
        ...
        TUFF_FURNACE_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "tuff_furnace_be"),
        ...
        END_STONE_FURNACE_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "end_stone_furnace_be"),
        ...
        DEEPSLATE_BLAST_FURNACE_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "deepslate_blast_furnace_be"),
        ...
        BLACKSTONE_BLAST_FURNACE_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco.MOD_ID + "blackstone_blast_furnace_be"),
        ...
        TUFF_BLAST_FURNACE_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "tuff_blast_furnace_be"),
        ...
        END_STONE_BLAST_FURNACE_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "end_stone_blast_furnace_be"),
        ...
        DEEPSLATE_SMOKER_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "deepslate_smoker_be"),
        ...
        BLACKSTONE_SMOKER_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "blackstone_smoker_be"),
        ...
        TUFF_SMOKER_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "tuff_smoker_be"),
        ...
        END_STONE_SMOKER_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "end_stone_smoker_be"),
        ...
        ACACIA_BARREL_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "acacia_barrel_be"),
        ...
        BIRCH_BARREL_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "birch_barrel_be"),
        ...
        OAK_BARREL_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "oak_barrel_be"),
        ...
        SPRUCE_BARREL_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "spruce_barrel_be"),
        ...
        JUNGLE_BARREL_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "jungle_barrel_be"),
        ...
        DARK_OAK_BARREL_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "dark_oak_barrel_be"),
        ...
        MANGROVE_BARREL_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "mangrove_barrel_be"),
        ...
        BAMBOO_BARREL_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "bamboo_barrel_be"),
        ...
        CHERRY_BARREL_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "cherry_barrel_be"),
        ...
        CRIMSON_BARREL_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "crimson_barrel_be"),
        ...
        WARPED_BARREL_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "warped_barrel_be"),
        ...
        CACTUS_BARREL_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "cactus_barrel_be"),
        ...
        PALE_OAK_BARREL_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "pale_oak_barrel_be"),
        ...
        DRIFTWOOD_BARREL_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "driftwood_barrel_be"),
        ...
        MUSHROOM_BARREL_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "mushroom_barrel_be"),
        ...
        IRON_CAP_BARREL_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.parse(VaranDeco. MOD_ID + "iron_cap_barrel_be"),
