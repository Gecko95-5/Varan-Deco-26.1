...
public class CoralWallBlock extends WallBlock {
    ...
    public CoralWallBlock(Block deadCoralBlock, Properties settings) {
        super(settings);
    ...
    public void tick(BlockState state, ServerLevel world, BlockPos pos, RandomSource random) {
        if (!scanForWater(state, world, pos)) {
            world.setBlock(pos, this.deadCoralBlock.defaultBlockState().setValue(WATERLOGGED, false), Block.UPDATE_CLIENTS);
        }
    }
