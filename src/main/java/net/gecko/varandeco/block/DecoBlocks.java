...
public class DecoBlocks {
    public static final Block CUT_GRANITE = registerBlock("cut_granite",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.POLISHED_GRANITE), Block::new);
    public static final Block GRANITE_BRICKS = registerBlock("granite_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.POLISHED_GRANITE), Block::new);
    public static final Block CUT_DIORITE = registerBlock("cut_diorite",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.POLISHED_DIORITE), Block::new);
    ...
    public static final Block CUT_ANDESITE = registerBlock("cut_andesite",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.POLISHED_ANDESITE), Block::new);
    public static final Block ANDESITE_BRICKS = registerBlock("andesite_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.POLISHED_ANDESITE), Block::new);
    public static final Block POLISHED_CALCITE = registerBlock("polished_calcite",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CALCITE).strength(1.0F), Block::new);
    public static final Block CUT_CALCITE = registerBlock("cut_calcite",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.POLISHED_CALCITE), Block::new);
    public static final Block CALCITE_BRICKS = registerBlock("calcite_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.POLISHED_CALCITE), Block::new);
    public static final Block DRIPSTONE_BRICKS = registerBlock("dripstone_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.DRIPSTONE_BLOCK).strength(2.0F, 1.0F), Block::new);
    public static final Block DRIPSTONE_BRICK_PILLAR = registerBlock("dripstone_brick_pillar",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.DRIPSTONE_BRICKS), PillarBlock::new);
    public static final Block CHISELED_DRIPSTONE = registerBlock("chiseled_dripstone",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.DRIPSTONE_BLOCK), Block::new);
    public static final Block DRY_GRASS_BLOCK = registerBlock("dry_grass_block",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.GRASS_BLOCK).mapColor(MapColor.YELLOW), SnowyBlock::new);
    public static final Block PACKED_GRASS = registerBlock("packed_grass",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.GRASS_BLOCK), PackedGrassBlock::new);
    public static final Block PACKED_DRY_GRASS = registerBlock("packed_dry_grass",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.DRY_GRASS_BLOCK), Block::new);
    public static final Block PACKED_PODZOL = registerBlock("packed_podzol",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PODZOL), Block::new);
    ...
    public static final Block CUT_IRON = registerBlock("cut_iron",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.IRON_BLOCK), Block::new);
    ...
    public static final Block CUT_IRON_SLAB = registerBlock("cut_iron_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CUT_IRON), SlabBlock::new);
    public static final Block CASTED_IRON = registerBlock("casted_iron",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.IRON_BLOCK).strength(10.0F, 6.0F)
    ...
    public static final Block CASTED_IRON_SLAB = registerBlock("casted_iron_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CASTED_IRON), SlabBlock::new);
    public static final Block CUT_GOLD = registerBlock("cut_gold",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.GOLD_BLOCK), Block::new);
    ...
    public static final Block CUT_GOLD_SLAB = registerBlock("cut_gold_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CUT_GOLD), SlabBlock::new);
    ...
    public static final Block IRON_GRATE = registerBlock("iron_grate",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.IRON_BLOCK).sounds(BlockSoundGroup.CHAIN)
    ...
    public static final Block GOLD_GRATE = registerBlock("gold_grate",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.GOLD_BLOCK).nonOpaque(), GrateBlock::new);
    ...
    public static final Block STRIPPED_DRIFTWOOD_LOG = registerBlock("stripped_driftwood_log",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.DRIED_DRIFTWOOD_LOG),PillarBlock::new);
    ...
    public static final Block HARDENED_GLASS = registerBlock("hardened_glass",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.GLASS).strength(25.0f,100.0f)
    ...
    public static final Block HARDENED_TINTED_GLASS = registerBlock("hardened_tinted_glass",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.TINTED_GLASS).strength(25.0f,100.0f)
                    .nonOpaque().requiresTool(),TintedGlassBlock::new);
    public static final Block CHISELED_LAPIS = registerBlock("chiseled_lapis",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LAPIS_BLOCK), Block::new);
    public static final Block LAPIS_BRICKS = registerBlock("lapis_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LAPIS_BLOCK).strength(4), Block::new);
    ...
    public static final Block LAPIS_PILLAR = registerBlock("lapis_pillar",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LAPIS_BLOCK), PillarBlock::new);
    ...
    public static final Block COBBLED_SANDSTONE = registerBlock("cobbled_sandstone",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SANDSTONE),Block::new);
    public static final Block CHISELED_POLISHED_SANDSTONE = registerBlock("chiseled_polished_sandstone",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CHISELED_SANDSTONE),Block::new);
    public static final Block POLISHED_SANDSTONE = registerBlock("polished_sandstone",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CUT_SANDSTONE),Block::new);
    public static final Block SANDSTONE_BRICKS = registerBlock("sandstone_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CUT_SANDSTONE_BRICKS),Block::new);
    public static final Block SMOOTH_OBSIDIAN = registerBlock("smooth_obsidian",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.OBSIDIAN).strength(60.0F, 1200.0F), Block::new);
    public static final Block SMOOTH_LAPIS = registerBlock("smooth_lapis",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LAPIS_BLOCK).mapColor(MapColor.BLUE),Block::new);
    public static final Block SMOOTH_PURPUR = registerBlock("smooth_purpur",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PURPUR_BLOCK), Block::new);
    public static final Block SMOOTH_DEEPSLATE = registerBlock("smooth_deepslate",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.DEEPSLATE).strength(3.5f,6.0f)
    ...
    public static final Block SMOOTH_TUFF = registerBlock("smooth_tuff",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.TUFF).strength(2.0f,6.0f)
    ...
    public static final Block SMOOTH_END_STONE = registerBlock("smooth_end_stone",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.END_STONE).strength(3.5F, 9.0F), Block::new);
    public static final Block CHISELED_BRICKS = registerBlock("chiseled_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BRICKS), Block::new);
    public static final Block CHISELED_OBSIDIAN = registerBlock("chiseled_obsidian",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.OBSIDIAN).mapColor(MapColor.PURPLE), Block::new);
    public static final Block SANDED_OBSIDIAN = registerBlock("sanded_obsidian",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.OBSIDIAN).mapColor(MapColor.PURPLE).strength(25.0F, 1200.0F), Block::new);
    public static final Block OBSIDIAN_BRICKS = registerBlock("obsidian_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SANDED_OBSIDIAN), Block::new);
    ...
    public static final Block OBSIDIAN_PILLAR = registerBlock("obsidian_pillar",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.OBSIDIAN).mapColor(MapColor.PURPLE),PillarBlock::new);
    ...
    public static final Block CHISELED_SNOW_BRICKS = registerBlock("chiseled_snow_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SNOW_BRICKS), Block::new);
    public static final Block JACK_O_SOUL_LANTERN = registerBlock("jack_o_soul_lantern",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CARVED_PUMPKIN).luminance(state -> 10),MovablePumpkinBlock::new);
    public static final Block PACKED_NETHERRACK = registerBlock("packed_netherrack",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NETHERRACK).strength(3.2F,1.0f), Block::new);
    public static final Block NETHERRACK_BRICKS = registerBlock("netherrack_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.PACKED_NETHERRACK), Block::new);
    public static final Block CHISELED_NETHERRACK_BRICKS = registerBlock("chiseled_netherrack_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.NETHERRACK_BRICKS), Block::new);
    public static final Block BASALT_BRICKS = registerBlock("basalt_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.POLISHED_BASALT), PillarBlock::new);
    public static final Block SMOOTH_GLOWSTONE = registerBlock("smooth_glowstone",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.GLOWSTONE).strength(0.6f), Block::new);

    public static final Block WHITE_LAMP = registerBlock("white_lamp",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor. WHITE), Block::new);
    public static final Block ORANGE_LAMP = registerBlock("orange_lamp",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.ORANGE), Block::new);
    public static final Block MAGENTA_LAMP = registerBlock("magenta_lamp",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.MAGENTA), Block::new);
    public static final Block LIGHT_BLUE_LAMP = registerBlock("light_blue_lamp",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.LIGHT_BLUE), Block::new);
    public static final Block YELLOW_LAMP = registerBlock("yellow_lamp",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.YELLOW), Block::new);
    public static final Block LIME_LAMP = registerBlock("lime_lamp",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.LIME), Block::new);
    public static final Block PINK_LAMP = registerBlock("pink_lamp",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.PINK), Block::new);
    public static final Block GRAY_LAMP = registerBlock("gray_lamp",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.GRAY), Block::new);
    public static final Block LIGHT_GRAY_LAMP = registerBlock("light_gray_lamp",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.LIGHT_GRAY), Block::new);
    public static final Block CYAN_LAMP = registerBlock("cyan_lamp",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.CYAN), Block::new);
    public static final Block PURPLE_LAMP = registerBlock("purple_lamp",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.PURPLE), Block::new);
    public static final Block BLUE_LAMP = registerBlock("blue_lamp",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.BLUE), Block::new);
    public static final Block BROWN_LAMP = registerBlock("brown_lamp",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.BROWN), Block::new);
    public static final Block GREEN_LAMP = registerBlock("green_lamp",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.GREEN), Block::new);
    public static final Block RED_LAMP = registerBlock("red_lamp",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.RED), Block::new);
    public static final Block BLACK_LAMP = registerBlock("black_lamp",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.BLACK), Block::new);
    ...
    public static final Block CRACKED_STONE_TILES = registerBlock("cracked_stone_tiles",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.STONE_TILES), Block::new);
    public static final Block CHISELED_MUD_BRICKS = registerBlock("chiseled_mud_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MUD_BRICKS), Block::new);
    public static final Block MOSSY_DEEPSLATE_BRICKS = registerBlock("mossy_deepslate_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.DEEPSLATE_BRICKS), Block::new);
    public static final Block PACKED_MYCELIUM = registerBlock("packed_mycelium",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MYCELIUM), PackedMyceliumBlock::new);
    public static final Block NETHER_BRICK_PILLAR = registerBlock("nether_brick_pillar",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NETHER_BRICKS), PillarBlock::new);
    public static final Block CHISELED_END_STONE = registerBlock("chiseled_end_stone",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.END_STONE), Block::new);
    public static final Block POLISHED_END_STONE = registerBlock("polished_end_stone",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.END_STONE).strength(4.0F, 9.0F), Block::new);
    public static final Block CHISELED_END_STONE_BRICKS = registerBlock("chiseled_end_stone_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.END_STONE_BRICKS), Block::new);
    ...
    public static final Block CRACKED_END_STONE_TILES = registerBlock("cracked_end_stone_tiles",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.END_STONE_TILES), Block::new);
    public static final Block VOID_STONE = registerBlock("void_stone",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.END_STONE).sounds(BlockSoundGroup.DEEPSLATE)
    ...
    public static final Block COBBLED_RED_SANDSTONE = registerBlock("cobbled_red_sandstone",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.RED_SANDSTONE), Block::new);
    public static final Block CHISELED_POLISHED_RED_SANDSTONE = registerBlock("chiseled_polished_red_sandstone",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CHISELED_RED_SANDSTONE), Block::new);
    public static final Block POLISHED_RED_SANDSTONE = registerBlock("polished_red_sandstone",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CUT_RED_SANDSTONE), Block::new);
    public static final Block RED_SANDSTONE_BRICKS = registerBlock("red_sandstone_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CUT_RED_SANDSTONE_BRICKS), Block::new);
    public static final Block CHISELED_PRISMARINE_BRICKS = registerBlock("chiseled_prismarine_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PRISMARINE).mapColor(MapColor.DIAMOND_BLUE), Block::new);
    public static final Block CRYSTALLIZED_PRISMARINE = registerBlock("crystallized_prismarine",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PRISMARINE).mapColor(MapColor.BRIGHT_TEAL)
    ...
    public static final Block LIGHT_PRISMARINE = registerBlock("light_prismarine",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PRISMARINE).mapColor(MapColor.OFF_WHITE)
                    .luminance(state -> 10).sounds(BlockSoundGroup.GLASS), Block::new);
    public static final Block ICE_BRICKS = registerBlock("ice_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PACKED_ICE).strength(1.4f), Block::new);
    public static final Block CHISELED_ICE_BRICKS = registerBlock("chiseled_ice_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.ICE_BRICKS), Block::new);
    ...
    public static final Block CHISELED_SOUL_SOILSTONE = registerBlock("chiseled_soul_soilstone",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SOUL_SOILSTONE), Block::new);
    ...
    public static final Block CUT_SOUL_SOILSTONE_BRICKS = registerBlock("cut_soul_soilstone_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CUT_SOUL_SOILSTONE), Block::new);
    ...
    public static final Block CHISELED_POLISHED_SOUL_SOILSTONE = registerBlock("chiseled_polished_soul_soilstone",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CHISELED_SOUL_SOILSTONE), Block::new);
    ...
    public static final Block SOUL_SOILSTONE_BRICKS = registerBlock("soul_soilstone_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CUT_SOUL_SOILSTONE_BRICKS), Block::new);
    public static final Block CHISELED_MAGMA_BLOCK = registerBlock("chiseled_magma_block",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MAGMA_BLOCK), MagmaBlock::new);
    public static final Block MAGMA_BRICKS = registerBlock("magma_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MAGMA_BLOCK).luminance(state -> 1)
    ...
    public static final Block CHISELED_MAGMA_BRICKS = registerBlock("chiseled_magma_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.MAGMA_BRICKS), MagmaBrickBlock::new);
    public static final Block BUBBLE_BLOCK = registerBlock("bubble_block",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.COBBLESTONE).strength(0.5F,25.0f)
    ...
    public static final Block CHISELED_BUBBLE_BLOCK = registerBlock("chiseled_bubble_block",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.BUBBLE_BLOCK), BubbleBlock::new);
    public static final Block BUBBLE_BRICKS = registerBlock("bubble_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.BUBBLE_BLOCK).strength(1.5F)
    ...
    public static final Block CHISELED_BUBBLE_BRICKS = registerBlock("chiseled_bubble_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.BUBBLE_BRICKS), BubbleBlock::new);
    public static final Block WIND_BLOCK = registerBlock("wind_block",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.TUFF).mapColor(MapColor.LIGHT_BLUE)
    ...
    public static final Block CHISELED_WIND_BLOCK = registerBlock("chiseled_wind_block",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.WIND_BLOCK), Block::new);
    public static final Block WIND_BRICKS = registerBlock("wind_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.WIND_BLOCK).strength(1.25F)
    ...
    public static final Block CHISELED_WIND_BRICKS = registerBlock("chiseled_wind_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.WIND_BRICKS), Block::new);
    public static final Block EARTH_BLOCK = registerBlock("earth_block",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.COBBLED_DEEPSLATE).mapColor(MapColor.BROWN)
    ...
    public static final Block CHISELED_EARTH_BLOCK = registerBlock("chiseled_earth_block",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.EARTH_BLOCK), Block::new);
    public static final Block EARTH_BRICKS = registerBlock("earth_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.EARTH_BLOCK).strength(3.0F)
    ...
    public static final Block CHISELED_EARTH_BRICKS = registerBlock("chiseled_earth_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.EARTH_BRICKS), Block::new);
    public static final Block CHISELED_RED_NETHER_BRICKS = registerBlock("chiseled_red_nether_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.RED_NETHER_BRICKS), Block::new);
    ...
    public static final Block RED_NETHER_BRICK_PILLAR = registerBlock("red_nether_brick_pillar",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.RED_NETHER_BRICKS), PillarBlock::new);
    public static final Block BLUE_NETHER_BRICKS = registerBlock("blue_nether_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NETHER_BRICKS).mapColor(MapColor.TEAL), Block::new);
    public static final Block CHISELED_BLUE_NETHER_BRICKS = registerBlock("chiseled_blue_nether_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.BLUE_NETHER_BRICKS), Block::new);
    ...
    public static final Block CRACKED_POLISHED_BLACKSTONE_TILES = registerBlock("cracked_polished_blackstone_tiles",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.POLISHED_BLACKSTONE_TILES),Block::new);
    ...
    public static final Block SOLID_CLOUD = registerBlock("solid_cloud",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.WHITE_WOOL).strength(0.8f,0.4f)
    ...
    public static final Block CLOUD_BRICKS = registerBlock("cloud_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SOLID_CLOUD).strength(1.2f,0.6f),TransparentBlock::new);
    ...
    public static final Block CRACKED_TUFF_TILES = registerBlock("cracked_tuff_tiles",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.TUFF_TILES), Block::new);
    public static final Block CRACKED_TUFF_BRICKS = registerBlock("cracked_tuff_bricks",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.TUFF_BRICKS), Block::new);
    ...
    public static final Block CHISELED_STONE = registerBlock("chiseled_stone",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.POLISHED_STONE), Block::new);
    ...
    public static final Block OAK_MOSAIC = registerBlock("oak_mosaic",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_PLANKS), Block::new);
    public static final Block SPRUCE_MOSAIC = registerBlock("spruce_mosaic",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SPRUCE_PLANKS), PillarBlock::new);
    public static final Block BIRCH_MOSAIC = registerBlock("birch_mosaic",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BIRCH_PLANKS), Block::new);
    public static final Block JUNGLE_MOSAIC = registerBlock("jungle_mosaic",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.JUNGLE_PLANKS), PillarBlock::new);
    public static final Block ACACIA_MOSAIC = registerBlock("acacia_mosaic",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.ACACIA_PLANKS), Block::new);
    public static final Block DARK_OAK_MOSAIC = registerBlock("dark_oak_mosaic",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.DARK_OAK_PLANKS), PillarBlock::new);
    public static final Block MANGROVE_MOSAIC = registerBlock("mangrove_mosaic",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MANGROVE_PLANKS), Block::new);
    public static final Block CHERRY_MOSAIC = registerBlock("cherry_mosaic",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CHERRY_PLANKS), Block::new);
    public static final Block PALE_OAK_MOSAIC = registerBlock("pale_oak_mosaic",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PALE_OAK_PLANKS), PillarBlock::new);
    public static final Block CRIMSON_MOSAIC = registerBlock("crimson_mosaic",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRIMSON_PLANKS), PillarBlock::new);
    public static final Block WARPED_MOSAIC = registerBlock("warped_mosaic",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.WARPED_PLANKS), Block::new);
    public static final Block CACTUS_MOSAIC = registerBlock("cactus_mosaic",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CACTUS_PLANKS), PillarBlock::new);
    public static final Block MUSHROOM_MOSAIC = registerBlock("mushroom_mosaic",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.MUSHROOM_PLANKS), Block::new);
    public static final Block DRIFTWOOD_MOSAIC = registerBlock("driftwood_mosaic",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.DRIFTWOOD_PLANKS), PillarBlock::new);
    public static final Block WOODEN_MOSAIC = registerBlock("wooden_mosaic",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.WOODEN_PLANKS), Block::new);
    public static final Block IRON_CAP_MOSAIC = registerBlock("iron_cap_mosaic",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.IRON_CAP_PLANKS), Block::new);

    public static final Block SMOOTH_RESIN = registerBlock("smooth_resin",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.RESIN_BLOCK).strength(1.5F, 6.0F)
    ...
    public static final Block SMOOTH_RESIN_SLAB = registerBlock("smooth_resin_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SMOOTH_RESIN),SlabBlock::new);
    public static final Block SMOOTH_RESIN_WALL = registerBlock("smooth_resin_wall",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SMOOTH_RESIN),WallBlock::new);
    ...
    public static final Block RESIN_SLAB = registerBlock("resin_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.RESIN_BLOCK),SlabBlock::new);
    public static final Block RESIN_WALL = registerBlock("resin_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.RESIN_BLOCK),WallBlock::new);
    ...
    public static final Block OAK_MOSAIC_SLAB = registerBlock("oak_mosaic_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.OAK_MOSAIC),SlabBlock::new);
    public static final Block SPRUCE_MOSAIC_SLAB = registerBlock("spruce_mosaic_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SPRUCE_MOSAIC),SlabBlock::new);
    public static final Block BIRCH_MOSAIC_SLAB = registerBlock("birch_mosaic_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.BIRCH_MOSAIC),SlabBlock::new);
    public static final Block JUNGLE_MOSAIC_SLAB = registerBlock("jungle_mosaic_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.JUNGLE_MOSAIC),SlabBlock::new);
    public static final Block ACACIA_MOSAIC_SLAB = registerBlock("acacia_mosaic_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.ACACIA_MOSAIC),SlabBlock::new);
    public static final Block DARK_OAK_MOSAIC_SLAB = registerBlock("dark_oak_mosaic_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.DARK_OAK_MOSAIC),SlabBlock::new);
    public static final Block MANGROVE_MOSAIC_SLAB = registerBlock("mangrove_mosaic_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.MANGROVE_MOSAIC),SlabBlock::new);
    public static final Block CHERRY_MOSAIC_SLAB = registerBlock("cherry_mosaic_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CHERRY_MOSAIC),SlabBlock::new);
    public static final Block PALE_OAK_MOSAIC_SLAB = registerBlock("pale_oak_mosaic_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.PALE_OAK_MOSAIC),SlabBlock::new);
    public static final Block CRIMSON_MOSAIC_SLAB = registerBlock("crimson_mosaic_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CRIMSON_MOSAIC),SlabBlock::new);
    public static final Block WARPED_MOSAIC_SLAB = registerBlock("warped_mosaic_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.WARPED_MOSAIC),SlabBlock::new);
    public static final Block CACTUS_MOSAIC_SLAB = registerBlock("cactus_mosaic_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CACTUS_MOSAIC),SlabBlock::new);
    public static final Block MUSHROOM_MOSAIC_SLAB = registerBlock("mushroom_mosaic_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.MUSHROOM_MOSAIC), SlabBlock::new);
    public static final Block DRIFTWOOD_MOSAIC_SLAB = registerBlock("driftwood_mosaic_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.DRIFTWOOD_MOSAIC),SlabBlock::new);
    public static final Block WOODEN_MOSAIC_SLAB = registerBlock("wooden_mosaic_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.WOODEN_MOSAIC),SlabBlock::new);
    public static final Block IRON_CAP_MOSAIC_SLAB = registerBlock("iron_cap_mosaic_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.IRON_CAP_MOSAIC), SlabBlock::new);
    ...
    public static final Block WARPED_WART_PLANT = registerBlock("warped_wart_plant",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NETHER_WART).mapColor(MapColor.BRIGHT_TEAL).nonOpaque(),
                    WarpedWartBlock::new);

    public static final Block DEEPSLATE_SLAB = registerBlock("deepslate_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.DEEPSLATE), SlabBlock::new);
    public static final Block CALCITE_SLAB = registerBlock("calcite_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CALCITE), SlabBlock::new);
    public static final Block DRIPSTONE_SLAB = registerBlock("dripstone_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.DRIPSTONE_BLOCK), SlabBlock::new);

    public static final Block GRASS_SLAB = registerBlock("grass_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.PACKED_GRASS), SlabBlock::new);
    public static final Block DRY_GRASS_SLAB = registerBlock("dry_grass_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.PACKED_DRY_GRASS), SlabBlock::new);
    public static final Block DIRT_SLAB = registerBlock("dirt_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.DIRT), SlabBlock::new);
    public static final Block COARSE_DIRT_SLAB = registerBlock("coarse_dirt_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.COARSE_DIRT), SlabBlock::new);
    public static final Block PODZOL_SLAB = registerBlock("podzol_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.PACKED_PODZOL), SlabBlock::new);
    public static final Block ROOTED_DIRT_SLAB = registerBlock("rooted_dirt_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.ROOTED_DIRT), SlabBlock::new);
    public static final Block MUD_SLAB = registerBlock("mud_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MUD), SlabBlock::new);
    public static final Block CRIMSON_NYLIUM_SLAB = registerBlock("crimson_nylium_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.PACKED_CRIMSON_NYLIUM), SlabBlock::new);
    public static final Block WARPED_NYLIUM_SLAB = registerBlock("warped_nylium_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.PACKED_WARPED_NYLIUM), SlabBlock::new);

    public static final Block BEDROCK_SLAB = registerBlock("bedrock_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BEDROCK), SlabBlock::new);

    public static final Block RAW_IRON_SLAB = registerBlock("raw_iron_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.RAW_IRON_BLOCK), SlabBlock::new);
    public static final Block RAW_COPPER_SLAB = registerBlock("raw_copper_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.RAW_COPPER_BLOCK), SlabBlock::new);
    public static final Block RAW_GOLD_SLAB = registerBlock("raw_gold_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.RAW_GOLD_BLOCK), SlabBlock::new);

    public static final Block IRON_SLAB = registerBlock("iron_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.IRON_BLOCK), SlabBlock::new);
    ...
    public static final Block WAXED_COPPER_SLAB = registerBlock("waxed_copper_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.WAXED_COPPER_BLOCK), SlabBlock::new);
    public static final Block WAXED_EXPOSED_COPPER_SLAB = registerBlock("waxed_exposed_copper_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.WAXED_EXPOSED_COPPER), SlabBlock::new);
    public static final Block WAXED_WEATHERED_COPPER_SLAB = registerBlock("waxed_weathered_copper_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.WAXED_WEATHERED_COPPER), SlabBlock::new);
    public static final Block WAXED_OXIDIZED_COPPER_SLAB = registerBlock("waxed_oxidized_copper_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.WAXED_OXIDIZED_COPPER), SlabBlock::new);
    public static final Block GOLD_SLAB = registerBlock("gold_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.GOLD_BLOCK), SlabBlock::new);

    public static final Block OAK_WOOD_SLAB = registerBlock("oak_wood_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_PLANKS).mapColor(MapColor.DIRT_BROWN), SlabBlock::new);
    public static final Block SPRUCE_WOOD_SLAB = registerBlock("spruce_wood_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SPRUCE_PLANKS).mapColor(MapColor.BROWN), SlabBlock::new);
    public static final Block BIRCH_WOOD_SLAB = registerBlock("birch_wood_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BIRCH_PLANKS).mapColor(MapColor.OFF_WHITE), SlabBlock::new);
    public static final Block JUNGLE_WOOD_SLAB = registerBlock("jungle_wood_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.JUNGLE_PLANKS).mapColor(MapColor.DIRT_BROWN), SlabBlock::new);
    public static final Block ACACIA_WOOD_SLAB = registerBlock("acacia_wood_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.ACACIA_PLANKS).mapColor(MapColor.STONE_GRAY), SlabBlock::new);
    public static final Block DARK_OAK_WOOD_SLAB = registerBlock("dark_oak_wood_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.DARK_OAK_PLANKS), SlabBlock::new);
    public static final Block MANGROVE_WOOD_SLAB = registerBlock("mangrove_wood_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MANGROVE_PLANKS).mapColor(MapColor.DIRT_BROWN), SlabBlock::new);
    public static final Block CHERRY_WOOD_SLAB = registerBlock("cherry_wood_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CHERRY_PLANKS).mapColor(MapColor.TERRACOTTA_GRAY), SlabBlock::new);
    public static final Block CRIMSON_HYPHAE_SLAB = registerBlock("crimson_hyphae_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRIMSON_PLANKS).sounds(BlockSoundGroup.NETHER_STEM)
    ...
    public static final Block WARPED_HYPHAE_SLAB = registerBlock("warped_hyphae_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.WARPED_PLANKS).sounds(BlockSoundGroup.NETHER_STEM)
                    .mapColor(MapColor.DARK_DULL_PINK), SlabBlock::new);
    public static final Block WOODEN_WOOD_SLAB = registerBlock("wooden_wood_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.WOODEN_PLANKS).mapColor(MapColor.TERRACOTTA_BROWN), SlabBlock::new);
    public static final Block IRON_CAP_HYPHAE_SLAB = registerBlock("iron_cap_hyphae_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.IRON_CAP_PLANKS).mapColor(MapColor.TERRACOTTA_GRAY)
    ...
    public static final Block BAMBOO_BLOCK_SLAB = registerBlock("bamboo_block_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BAMBOO_PLANKS).mapColor(MapColor.DARK_GREEN), SlabBlock::new);

    public static final Block STRIPPED_OAK_WOOD_SLAB = registerBlock("stripped_oak_wood_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_PLANKS), SlabBlock::new);
    public static final Block STRIPPED_SPRUCE_WOOD_SLAB = registerBlock("stripped_spruce_wood_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SPRUCE_PLANKS), SlabBlock::new);
    public static final Block STRIPPED_BIRCH_WOOD_SLAB = registerBlock("stripped_birch_wood_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BIRCH_PLANKS), SlabBlock::new);
    public static final Block STRIPPED_JUNGLE_WOOD_SLAB = registerBlock("stripped_jungle_wood_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.JUNGLE_PLANKS), SlabBlock::new);
    public static final Block STRIPPED_ACACIA_WOOD_SLAB = registerBlock("stripped_acacia_wood_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.ACACIA_PLANKS), SlabBlock::new);
    ...
    public static final Block STRIPPED_MANGROVE_WOOD_SLAB = registerBlock("stripped_mangrove_wood_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MANGROVE_PLANKS), SlabBlock::new);
    ...
    public static final Block STRIPPED_CRIMSON_HYPHAE_SLAB = registerBlock("stripped_crimson_hyphae_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRIMSON_PLANKS).sounds(BlockSoundGroup.NETHER_STEM), SlabBlock::new);
    public static final Block STRIPPED_WARPED_HYPHAE_SLAB = registerBlock("stripped_warped_hyphae_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.WARPED_PLANKS).sounds(BlockSoundGroup.NETHER_STEM), SlabBlock::new);
    public static final Block STRIPPED_WOODEN_WOOD_SLAB = registerBlock("stripped_wooden_wood_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.WOODEN_PLANKS), SlabBlock::new);
    public static final Block STRIPPED_IRON_CAP_HYPHAE_SLAB = registerBlock("stripped_iron_cap_hyphae_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.IRON_CAP_PLANKS).sounds(BlockSoundGroup.NETHER_STEM), SlabBlock::new);

    public static final Block STRIPPED_BAMBOO_SLAB = registerBlock("stripped_bamboo_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BAMBOO_PLANKS), SlabBlock::new);

    public static final Block LAPIS_SLAB = registerBlock("lapis_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LAPIS_BLOCK), SlabBlock::new);

    public static final Block WHITE_WOOL_SLAB = registerBlock("white_wool_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.WHITE_WOOL), SlabBlock::new);
    public static final Block ORANGE_WOOL_SLAB = registerBlock("orange_wool_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.ORANGE_WOOL), SlabBlock::new);
    public static final Block MAGENTA_WOOL_SLAB = registerBlock("magenta_wool_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MAGENTA_WOOL), SlabBlock::new);
    public static final Block LIGHT_BLUE_WOOL_SLAB = registerBlock("light_blue_wool_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LIGHT_BLUE_WOOL), SlabBlock::new);
    public static final Block YELLOW_WOOL_SLAB = registerBlock("yellow_wool_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.YELLOW_WOOL), SlabBlock::new);
    public static final Block LIME_WOOL_SLAB = registerBlock("lime_wool_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LIME_WOOL), SlabBlock::new);
    public static final Block PINK_WOOL_SLAB = registerBlock("pink_wool_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PINK_WOOL), SlabBlock::new);
    public static final Block GRAY_WOOL_SLAB = registerBlock("gray_wool_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.GRAY_WOOL), SlabBlock::new);
    public static final Block LIGHT_GRAY_WOOL_SLAB = registerBlock("light_gray_wool_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LIGHT_GRAY_WOOL), SlabBlock::new);
    public static final Block CYAN_WOOL_SLAB = registerBlock("cyan_wool_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CYAN_WOOL), SlabBlock::new);
    public static final Block PURPLE_WOOL_SLAB = registerBlock("purple_wool_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PURPLE_WOOL), SlabBlock::new);
    public static final Block BLUE_WOOL_SLAB = registerBlock("blue_wool_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BLUE_WOOL), SlabBlock::new);
    public static final Block BROWN_WOOL_SLAB = registerBlock("brown_wool_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BROWN_WOOL), SlabBlock::new);
    public static final Block GREEN_WOOL_SLAB = registerBlock("green_wool_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.GREEN_WOOL), SlabBlock::new);
    public static final Block RED_WOOL_SLAB = registerBlock("red_wool_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.RED_WOOL), SlabBlock::new);
    public static final Block BLACK_WOOL_SLAB  = registerBlock("black_wool_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BLACK_WOOL), SlabBlock::new);

    public static final Block OBSIDIAN_SLAB = registerBlock("obsidian_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.OBSIDIAN), SlabBlock::new);
    public static final Block SNOW_SLAB = registerBlock("snow_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SNOW_BLOCK), SlabBlock::new);
    public static final Block CLAY_SLAB = registerBlock("clay_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CLAY), SlabBlock::new);
    public static final Block NETHERRACK_SLAB = registerBlock("netherrack_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NETHERRACK), SlabBlock::new);
    public static final Block SMOOTH_BASALT_SLAB = registerBlock("smooth_basalt_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMOOTH_BASALT), SlabBlock::new);
    public static final Block CRACKED_STONE_BRICK_SLAB = registerBlock("cracked_stone_brick_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRACKED_STONE_BRICKS), SlabBlock::new);
    public static final Block PACKED_MUD_SLAB = registerBlock("packed_mud_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PACKED_MUD), SlabBlock::new);
    public static final Block CRACKED_DEEPSLATE_BRICK_SLAB = registerBlock("cracked_deepslate_brick_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRACKED_DEEPSLATE_BRICKS), SlabBlock::new);
    public static final Block CRACKED_DEEPSLATE_TILE_SLAB = registerBlock("cracked_deepslate_tile_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRACKED_DEEPSLATE_TILES), SlabBlock::new);
    public static final Block MYCELIUM_SLAB = registerBlock("packed_mycelium_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.PACKED_MYCELIUM), SlabBlock::new);
    public static final Block CRACKED_NETHER_BRICK_SLAB = registerBlock("cracked_nether_brick_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRACKED_NETHER_BRICKS), SlabBlock::new);
    public static final Block END_STONE_SLAB = registerBlock("end_stone_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.END_STONE), SlabBlock::new);
    public static final Block QUARTZ_BRICK_SLAB = registerBlock("quartz_brick_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.QUARTZ_BRICKS), SlabBlock::new);
    public static final Block WHITE_TERRACOTTA_SLAB = registerBlock("white_terracotta_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.WHITE_TERRACOTTA), SlabBlock::new);
    public static final Block ORANGE_TERRACOTTA_SLAB = registerBlock("orange_terracotta_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.ORANGE_TERRACOTTA), SlabBlock::new);
    public static final Block MAGENTA_TERRACOTTA_SLAB = registerBlock("magenta_terracotta_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MAGENTA_TERRACOTTA), SlabBlock::new);
    public static final Block LIGHT_BLUE_TERRACOTTA_SLAB = registerBlock("light_blue_terracotta_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LIGHT_BLUE_TERRACOTTA), SlabBlock::new);
    public static final Block YELLOW_TERRACOTTA_SLAB = registerBlock("yellow_terracotta_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.YELLOW_TERRACOTTA), SlabBlock::new);
    public static final Block LIME_TERRACOTTA_SLAB = registerBlock("lime_terracotta_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LIME_TERRACOTTA), SlabBlock::new);
    public static final Block PINK_TERRACOTTA_SLAB = registerBlock("pink_terracotta_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PINK_TERRACOTTA), SlabBlock::new);
    public static final Block GRAY_TERRACOTTA_SLAB = registerBlock("gray_terracotta_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.GRAY_TERRACOTTA), SlabBlock::new);
    public static final Block LIGHT_GRAY_TERRACOTTA_SLAB = registerBlock("light_gray_terracotta_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LIGHT_GRAY_TERRACOTTA), SlabBlock::new);
    public static final Block CYAN_TERRACOTTA_SLAB = registerBlock("cyan_terracotta_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CYAN_TERRACOTTA), SlabBlock::new);
    public static final Block PURPLE_TERRACOTTA_SLAB = registerBlock("purple_terracotta_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PURPLE_TERRACOTTA), SlabBlock::new);
    public static final Block BLUE_TERRACOTTA_SLAB = registerBlock("blue_terracotta_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BLUE_TERRACOTTA), SlabBlock::new);
    public static final Block BROWN_TERRACOTTA_SLAB = registerBlock("brown_terracotta_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BROWN_TERRACOTTA), SlabBlock::new);
    public static final Block GREEN_TERRACOTTA_SLAB = registerBlock("green_terracotta_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.GREEN_TERRACOTTA), SlabBlock::new);
    public static final Block RED_TERRACOTTA_SLAB = registerBlock("red_terracotta_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.RED_TERRACOTTA), SlabBlock::new);
    public static final Block BLACK_TERRACOTTA_SLAB = registerBlock("black_terracotta_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BLACK_TERRACOTTA), SlabBlock::new);
    public static final Block HAY_SLAB = registerBlock("hay_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.HAY_BLOCK), HaySlabBlock::new);
    public static final Block TERRACOTTA_SLAB = registerBlock("terracotta_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.TERRACOTTA), SlabBlock::new);
    public static final Block PACKED_ICE_SLAB = registerBlock("packed_ice_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PACKED_ICE), SlabBlock::new);
    public static final Block MAGMA_SLAB = registerBlock("magma_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MAGMA_BLOCK), MagmaSlabBlock::new);
    public static final Block NETHER_WART_SLAB = registerBlock("nether_wart_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NETHER_WART_BLOCK), SlabBlock::new);
    public static final Block WARPED_WART_SLAB = registerBlock("warped_wart_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.WARPED_WART_BLOCK), SlabBlock::new);
    public static final Block BONE_SLAB = registerBlock("bone_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BONE_BLOCK), SlabBlock::new);
    public static final Block DEAD_TUBE_CORAL_SLAB = registerBlock("dead_tube_coral_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.DEAD_TUBE_CORAL_BLOCK), SlabBlock::new);
    public static final Block DEAD_BRAIN_CORAL_SLAB = registerBlock("dead_brain_coral_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.DEAD_BRAIN_CORAL_BLOCK), SlabBlock::new);
    public static final Block DEAD_BUBBLE_CORAL_SLAB = registerBlock("dead_bubble_coral_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.DEAD_BUBBLE_CORAL_BLOCK), SlabBlock::new);
    public static final Block DEAD_FIRE_CORAL_SLAB = registerBlock("dead_fire_coral_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.DEAD_FIRE_CORAL_BLOCK), SlabBlock::new);
    public static final Block DEAD_HORN_CORAL_SLAB = registerBlock("dead_horn_coral_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.DEAD_HORN_CORAL_BLOCK), SlabBlock::new);
    ...
    public static final Block WHITE_CONCRETE_SLAB = registerBlock("white_concrete_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.WHITE_CONCRETE), SlabBlock::new);
    public static final Block ORANGE_CONCRETE_SLAB = registerBlock("orange_concrete_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.ORANGE_CONCRETE), SlabBlock::new);
    public static final Block MAGENTA_CONCRETE_SLAB = registerBlock("magenta_concrete_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MAGENTA_CONCRETE), SlabBlock::new);
    public static final Block LIGHT_BLUE_CONCRETE_SLAB = registerBlock("light_blue_concrete_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LIGHT_BLUE_CONCRETE), SlabBlock::new);
    public static final Block YELLOW_CONCRETE_SLAB = registerBlock("yellow_concrete_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.YELLOW_CONCRETE), SlabBlock::new);
    public static final Block LIME_CONCRETE_SLAB = registerBlock("lime_concrete_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LIME_CONCRETE), SlabBlock::new);
    public static final Block PINK_CONCRETE_SLAB = registerBlock("pink_concrete_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PINK_CONCRETE), SlabBlock::new);
    public static final Block GRAY_CONCRETE_SLAB = registerBlock("gray_concrete_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.GRAY_CONCRETE), SlabBlock::new);
    public static final Block LIGHT_GRAY_CONCRETE_SLAB = registerBlock("light_gray_concrete_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LIGHT_GRAY_CONCRETE), SlabBlock::new);
    public static final Block CYAN_CONCRETE_SLAB = registerBlock("cyan_concrete_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CYAN_CONCRETE), SlabBlock::new);
    public static final Block PURPLE_CONCRETE_SLAB = registerBlock("purple_concrete_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PURPLE_CONCRETE), SlabBlock::new);
    public static final Block BLUE_CONCRETE_SLAB = registerBlock("blue_concrete_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BLUE_CONCRETE), SlabBlock::new);
    public static final Block BROWN_CONCRETE_SLAB = registerBlock("brown_concrete_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BROWN_CONCRETE), SlabBlock::new);
    public static final Block GREEN_CONCRETE_SLAB = registerBlock("green_concrete_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.GREEN_CONCRETE), SlabBlock::new);
    public static final Block RED_CONCRETE_SLAB = registerBlock("red_concrete_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.RED_CONCRETE), SlabBlock::new);
    public static final Block BLACK_CONCRETE_SLAB = registerBlock("black_concrete_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BLACK_CONCRETE), SlabBlock::new);
    public static final Block BLUE_ICE_SLAB = registerBlock("blue_ice_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BLUE_ICE), SlabBlock::new);
    public static final Block CRACKED_POLISHED_BLACKSTONE_BRICK_SLAB = registerBlock("cracked_polished_blackstone_brick_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS), SlabBlock::new);
    public static final Block MOSS_SLAB = registerBlock("moss_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MOSS_BLOCK), SlabBlock::new);
    public static final Block PALE_MOSS_SLAB = registerBlock("pale_moss_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PALE_MOSS_BLOCK), SlabBlock::new);
    public static final Block SCULK_SLAB = registerBlock("sculk_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SCULK), SlabBlock::new);
    public static final Block HONEYCOMB_SLAB = registerBlock("honeycomb_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.HONEYCOMB_BLOCK), SlabBlock::new);

    public static final Block CUT_GRANITE_SLAB = registerBlock("cut_granite_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CUT_GRANITE), SlabBlock::new);
    public static final Block GRANITE_BRICK_SLAB = registerBlock("granite_brick_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.GRANITE_BRICKS), SlabBlock::new);
    public static final Block CUT_DIORITE_SLAB = registerBlock("cut_diorite_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CUT_DIORITE), SlabBlock::new);
    public static final Block DIORITE_BRICK_SLAB = registerBlock("diorite_brick_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.DIORITE_BRICKS), SlabBlock::new);
    public static final Block CUT_ANDESITE_SLAB = registerBlock("cut_andesite_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CUT_ANDESITE), SlabBlock::new);
    public static final Block ANDESITE_BRICK_SLAB = registerBlock("andesite_brick_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.ANDESITE_BRICKS), SlabBlock::new);
    public static final Block POLISHED_CALCITE_SLAB = registerBlock("polished_calcite_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.POLISHED_CALCITE), SlabBlock::new);
    public static final Block CUT_CALCITE_SLAB = registerBlock("cut_calcite_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CUT_CALCITE), SlabBlock::new);
    public static final Block CALCITE_BRICK_SLAB = registerBlock("calcite_brick_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CALCITE_BRICKS), SlabBlock::new);
    public static final Block DRIPSTONE_BRICK_SLAB = registerBlock("dripstone_brick_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.DRIPSTONE_BRICKS), SlabBlock::new);
    public static final Block DRIPSTONE_BRICK_PILLAR_SLAB = registerBlock("dripstone_brick_pillar_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.DRIPSTONE_BRICK_PILLAR), SlabBlock::new);
    public static final Block CACTUS_PLANK_SLAB = registerBlock("cactus_plank_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CACTUS_PLANKS), SlabBlock::new);
    public static final Block MUSHROOM_SLAB = registerBlock("mushroom_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.MUSHROOM_PLANKS), SlabBlock::new);
    public static final Block IRON_CAP_SLAB = registerBlock("iron_cap_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.IRON_CAP_PLANKS), SlabBlock::new);
    ...
    public static final Block STRIPPED_PALE_OAK_WOOD_SLAB = registerBlock("stripped_pale_oak_wood_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PALE_OAK_PLANKS), SlabBlock::new);
    public static final Block PALE_OAK_WOOD_SLAB = registerBlock("pale_oak_wood_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PALE_OAK_PLANKS).mapColor(MapColor.STONE_GRAY), SlabBlock::new);
    public static final Block SMOOTH_TUFF_SLAB = registerBlock("smooth_tuff_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SMOOTH_TUFF),SlabBlock::new);
    public static final Block WIND_SLAB = registerBlock("wind_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.WIND_BLOCK),SlabBlock::new);
    public static final Block WIND_BRICK_SLAB = registerBlock("wind_brick_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.WIND_BRICKS),SlabBlock::new);
    public static final Block EARTH_SLAB = registerBlock("earth_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.EARTH_BLOCK),SlabBlock::new);
    public static final Block EARTH_BRICK_SLAB = registerBlock("earth_brick_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.EARTH_BRICKS),SlabBlock::new);
    public static final Block TUFF_TILE_SLAB = registerBlock("tuff_tile_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.TUFF_TILES),SlabBlock::new);
    public static final Block CRACKED_TUFF_BRICK_SLAB = registerBlock("cracked_tuff_brick_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CRACKED_TUFF_BRICKS),SlabBlock::new);
    public static final Block MOSSY_TUFF_BRICK_SLAB = registerBlock("mossy_tuff_brick_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.MOSSY_TUFF_BRICKS),SlabBlock::new);
    public static final Block CRACKED_TUFF_TILE_SLAB = registerBlock("cracked_tuff_tile_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CRACKED_TUFF_TILES),SlabBlock::new);
    public static final Block DRIFTWOOD_SLAB = registerBlock("driftwood_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.DRIFTWOOD_PLANKS), SlabBlock::new);
    ...
    public static final Block DRIFTWOOD_LOG_SLAB = registerBlock("driftwood_log_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.DRIFTWOOD_PLANKS).mapColor(MapColor.LIGHT_BLUE), SlabBlock::new);
    public static final Block DRIED_DRIFTWOOD_SLAB = registerBlock("dried_driftwood_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.DRIFTWOOD_PLANKS).mapColor(MapColor.TERRACOTTA_WHITE), SlabBlock::new);
    ...
    public static final Block DRIED_LEAVES = registerBlock("dried_leaves",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.JUNGLE_LEAVES).mapColor(MapColor.BROWN)
    ...
    public static final Block KELP_LEAVES = registerBlock("kelp_leaves",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.JUNGLE_LEAVES).sounds(BlockSoundGroup.WET_GRASS)
    ...
    public static final Block DEAD_KELP_LEAVES = registerBlock("dead_kelp_leaves",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.JUNGLE_LEAVES).sounds(BlockSoundGroup.HANGING_ROOTS)
    ...
    public static final Block ROUGE_WILDFLOWERS = registerBlock("rouge_wildflowers",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.WILDFLOWERS), FlowerbedBlock::new);
    ...
    public static final Block ANCIENT_ROSE_CROP = registerBlock("ancient_rose_crop",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.TORCHFLOWER_CROP).nonOpaque(), AncientRoseBlock::new);

    public static final Block MIGHTY_LAVENDER_CROP = registerBlock("mighty_lavender_crop",
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.TORCHFLOWER_CROP), MightyLavenderCropBlock::new);
    ...
    public static final Block MIGHTY_LAVENDER = registerBlock("mighty_lavender",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PEONY), MightyLavenderBlock::new);

    public static final Block OAK_CRAFTING_TABLE = registerBlock("oak_crafting_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRAFTING_TABLE).mapColor(MapColor.OAK_TAN), OakCraftingTableBlock::new);
    public static final Block SPRUCE_CRAFTING_TABLE = registerBlock("spruce_crafting_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRAFTING_TABLE).mapColor(MapColor.SPRUCE_BROWN), SpruceCraftingTableBlock::new);
    public static final Block BIRCH_CRAFTING_TABLE = registerBlock("birch_crafting_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRAFTING_TABLE).mapColor(MapColor.PALE_YELLOW), BirchCraftingTableBlock::new);
    public static final Block JUNGLE_CRAFTING_TABLE = registerBlock("jungle_crafting_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRAFTING_TABLE).mapColor(MapColor.DIRT_BROWN), JungleCraftingTableBlock::new);
    public static final Block ACACIA_CRAFTING_TABLE = registerBlock("acacia_crafting_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRAFTING_TABLE).mapColor(MapColor.GRAY), AcaciaCraftingTableBlock::new);
    public static final Block DARK_OAK_CRAFTING_TABLE = registerBlock("dark_oak_crafting_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRAFTING_TABLE).mapColor(MapColor.BROWN), DarkOakCraftingTableBlock::new);
    public static final Block MANGROVE_CRAFTING_TABLE = registerBlock("mangrove_crafting_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRAFTING_TABLE).mapColor(MapColor.RED), MangroveCraftingTableBlock::new);
    public static final Block BAMBOO_CRAFTING_TABLE = registerBlock("bamboo_crafting_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRAFTING_TABLE).mapColor(MapColor.GREEN).sounds(BlockSoundGroup.BAMBOO_WOOD),
                BambooCraftingTableBlock::new);
    public static final Block CHERRY_CRAFTING_TABLE = registerBlock("cherry_crafting_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRAFTING_TABLE).mapColor(MapColor.TERRACOTTA_GRAY).sounds(BlockSoundGroup.CHERRY_WOOD),
                CherryCraftingTableBlock::new);
    public static final Block PALE_OAK_CRAFTING_TABLE = registerBlock("pale_oak_crafting_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRAFTING_TABLE).mapColor(MapColor.STONE_GRAY), PaleOakCraftingTableBlock::new);
    public static final Block CRIMSON_CRAFTING_TABLE = registerBlock("crimson_crafting_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRAFTING_TABLE).mapColor(MapColor.DULL_PINK).sounds(BlockSoundGroup.NETHER_WOOD),
                CrimsonCraftingTableBlock::new);
    public static final Block WARPED_CRAFTING_TABLE = registerBlock("warped_crafting_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRAFTING_TABLE).mapColor(MapColor.TEAL).sounds(BlockSoundGroup.NETHER_WOOD),
                WarpedCraftingTableBlock::new);
    public static final Block CACTUS_CRAFTING_TABLE = registerBlock("cactus_crafting_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRAFTING_TABLE).mapColor(MapColor.DARK_GREEN), CactusCraftingTableBlock::new);
    public static final Block MUSHROOM_CRAFTING_TABLE = registerBlock("mushroom_crafting_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRAFTING_TABLE).mapColor(MapColor.OFF_WHITE), MushroomCraftingTableBlock::new);
    public static final Block IRON_CAP_CRAFTING_TABLE = registerBlock("iron_cap_crafting_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRAFTING_TABLE).mapColor(MapColor.TERRACOTTA_GRAY)
    ...
    public static final Block DRIFTWOOD_CRAFTING_TABLE = registerBlock("driftwood_crafting_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRAFTING_TABLE).mapColor(MapColor.LIGHT_BLUE), DriftwoodCraftingTableBlock::new);

    public static final Block DEEPSLATE_FURNACE = registerBlock("deepslate_furnace",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.FURNACE).mapColor(MapColor.DEEPSLATE_GRAY)
    ...
    public static final Block BLACKSTONE_FURNACE = registerBlock("blackstone_furnace",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.FURNACE).mapColor(MapColor.BLACK)
                    .strength(3.0f), BlackstoneFurnaceBlock::new);
    public static final Block TUFF_FURNACE = registerBlock("tuff_furnace",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.FURNACE).mapColor(MapColor.TERRACOTTA_GRAY)
    ...
    public static final Block END_STONE_FURNACE = registerBlock("end_stone_furnace",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.FURNACE).mapColor(MapColor.PALE_YELLOW)
                    .strength(4.5f),EndstoneFurnaceBlock::new);

    public static final Block SPRUCE_LADDER = registerBlock("spruce_ladder",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LADDER),LadderBlock::new);
    ...
    public static final Block CRIMSON_LADDER = registerBlock("crimson_ladder",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LADDER)
    ...
    public static final Block IRON_LADDER = registerBlock("iron_ladder",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LADDER).sounds(BlockSoundGroup.METAL)
    ...
    public static final Block WAXED_COPPER_LADDER = registerBlock("waxed_copper_ladder",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.COPPER_LADDER),LadderBlock::new);
    public static final Block WAXED_EXPOSED_COPPER_LADDER = registerBlock("waxed_exposed_copper_ladder",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.EXPOSED_COPPER_LADDER),LadderBlock::new);
    public static final Block WAXED_WEATHERED_COPPER_LADDER = registerBlock("waxed_weathered_copper_ladder",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.WEATHERED_COPPER_LADDER),LadderBlock::new);
    public static final Block WAXED_OXIDIZED_COPPER_LADDER = registerBlock("waxed_oxidized_copper_ladder",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.OXIDIZED_COPPER_LADDER),LadderBlock::new);

    public static final Block GRASS_CARPET = registerBlock("grass_carpet",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MOSS_CARPET).sounds(BlockSoundGroup.GRASS),CarpetBlock::new);
    public static final Block DRY_GRASS_CARPET = registerBlock("dry_grass_carpet",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MOSS_CARPET).sounds(BlockSoundGroup.GRASS)
                    .mapColor(MapColor.YELLOW),CarpetBlock::new);
    public static final Block PODZOL_CARPET = registerBlock("podzol_carpet",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MOSS_CARPET).mapColor(MapColor.SPRUCE_BROWN)
    ...
    public static final Block CRIMSON_NYLIUM_CARPET = registerBlock("crimson_nylium_carpet",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MOSS_CARPET).mapColor(MapColor.DULL_RED)
    ...
    public static final Block WARPED_NYLIUM_CARPET = registerBlock("warped_nylium_carpet",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MOSS_CARPET).mapColor(MapColor.TEAL)
                    .sounds(BlockSoundGroup.NYLIUM),CarpetBlock::new);
    public static final Block MYCELIUM_CARPET = registerBlock("mycelium_carpet",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MOSS_CARPET).mapColor(MapColor.PURPLE)
                    .sounds(BlockSoundGroup.GRASS),CarpetBlock::new);

    public static final Block HAY_CARPET = registerBlock("hay_carpet",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MOSS_CARPET).mapColor(MapColor.YELLOW)
                    .sounds(BlockSoundGroup.GRASS),CarpetBlock::new);
    public static final Block SCULK_CARPET = registerBlock("sculk_carpet",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MOSS_CARPET).mapColor(MapColor.BLACK)
                    .sounds(BlockSoundGroup.SCULK),CarpetBlock::new);

    public static final Block PACKED_CACTUS = registerBlock("packed_cactus",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.DARK_OAK_WOOD).strength(0.4F).sounds(BlockSoundGroup.WOOL)
                    .mapColor(MapColor.GREEN),PillarBlock::new);
    public static final Block STRIPPED_CACTUS = registerBlock("stripped_cactus",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.PACKED_CACTUS).mapColor(MapColor.PALE_GREEN),PillarBlock::new);

    public static final Block CACTUS_PLANK_FENCE = registerBlock("cactus_plank_fence",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CACTUS_PLANKS),FenceBlock::new);
    public static final Block MUSHROOM_FENCE = registerBlock("mushroom_fence",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.MUSHROOM_PLANKS),FenceBlock::new);
    public static final Block IRON_CAP_FENCE = registerBlock("iron_cap_fence",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.IRON_CAP_PLANKS),FenceBlock::new);
    public static final Block WOODEN_FENCE = registerBlock("wooden_fence",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.WOODEN_PLANKS),FenceBlock::new);
    public static final Block DRIFTWOOD_FENCE = registerBlock("driftwood_fence",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.DRIFTWOOD_PLANKS),FenceBlock::new);
    ...
    public static final Block RED_NETHER_BRICK_FENCE = registerBlock("red_nether_brick_fence",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.RED_NETHER_BRICKS),FenceBlock::new);
    public static final Block BLUE_NETHER_BRICK_FENCE = registerBlock("blue_nether_brick_fence",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.BLUE_NETHER_BRICKS),FenceBlock::new);

    public static final Block LIGHT_IRON_BARS = registerBlock("light_iron_bars",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.IRON_BARS).strength(2.5f,6.0f),PaneBlock::new);
    ...
    public static final Block WAXED_LIGHT_COPPER_BARS = registerBlock("waxed_light_copper_bars",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.LIGHT_COPPER_BARS),PaneBlock::new);
    ...
    public static final Block WAXED_EXPOSED_LIGHT_COPPER_BARS = registerBlock("waxed_exposed_light_copper_bars",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.EXPOSED_LIGHT_COPPER_BARS),PaneBlock::new);
    ...
    public static final Block WAXED_WEATHERED_LIGHT_COPPER_BARS = registerBlock("waxed_weathered_light_copper_bars",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.WEATHERED_LIGHT_COPPER_BARS),PaneBlock::new);
    ...
    public static final Block WAXED_OXIDIZED_LIGHT_COPPER_BARS = registerBlock("waxed_oxidized_light_copper_bars",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.OXIDIZED_LIGHT_COPPER_BARS),PaneBlock::new);
    public static final Block LIGHT_GOLD_BARS = registerBlock("light_gold_bars",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.LIGHT_IRON_BARS).sounds(BlockSoundGroup.METAL),PaneBlock::new);

    public static final Block GOLD_BARS = registerBlock("gold_bars",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.IRON_BARS).sounds(BlockSoundGroup.METAL),PaneBlock::new);

    public static final Block HEAVY_IRON_BARS = registerBlock("heavy_iron_bars",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.IRON_BARS).strength(10.0f,12.0f)
    ...
    public static final Block WAXED_HEAVY_COPPER_BARS = registerBlock("waxed_heavy_copper_bars",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.HEAVY_COPPER_BARS),PaneBlock::new);
    ...
    public static final Block WAXED_EXPOSED_HEAVY_COPPER_BARS = registerBlock("waxed_exposed_heavy_copper_bars",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.EXPOSED_HEAVY_COPPER_BARS),PaneBlock::new);
    ...
    public static final Block WAXED_WEATHERED_HEAVY_COPPER_BARS = registerBlock("waxed_weathered_heavy_copper_bars",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.WEATHERED_HEAVY_COPPER_BARS),PaneBlock::new);
    ...
    public static final Block WAXED_OXIDIZED_HEAVY_COPPER_BARS = registerBlock("waxed_oxidized_heavy_copper_bars",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.OXIDIZED_HEAVY_COPPER_BARS),PaneBlock::new);
    public static final Block HEAVY_GOLD_BARS = registerBlock("heavy_gold_bars",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.HEAVY_IRON_BARS).sounds(BlockSoundGroup.METAL)
    ...
    public static final Block CRACKED_NETHER_BRICK_FENCE = registerBlock("cracked_nether_brick_fence",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRACKED_NETHER_BRICKS),FenceBlock::new);
    public static final Block CRACKED_RED_NETHER_BRICK_FENCE = registerBlock("cracked_red_nether_brick_fence",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CRACKED_RED_NETHER_BRICKS),FenceBlock::new);
    public static final Block CRACKED_BLUE_NETHER_BRICK_FENCE = registerBlock("cracked_blue_nether_brick_fence",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CRACKED_BLUE_NETHER_BRICKS),FenceBlock::new);

    public static final Block STONE_WALL = registerBlock("stone_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.STONE),WallBlock::new);
    public static final Block POLISHED_ANDESITE_WALL = registerBlock("polished_andesite_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.POLISHED_ANDESITE),WallBlock::new);
    public static final Block POLISHED_DIORITE_WALL = registerBlock("polished_diorite_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.POLISHED_DIORITE),WallBlock::new);
    public static final Block POLISHED_GRANITE_WALL = registerBlock("polished_granite_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.POLISHED_GRANITE),WallBlock::new);
    public static final Block DEEPSLATE_WALL = registerBlock("deepslate_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.DEEPSLATE),WallBlock::new);
    public static final Block CALCITE_WALL = registerBlock("calcite_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CALCITE),WallBlock::new);
    public static final Block DRIPSTONE_WALL = registerBlock("dripstone_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.DRIPSTONE_BLOCK), WallBlock::new);

    public static final Block DIRT_WALL = registerBlock("dirt_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.DIRT), WallBlock::new);
    public static final Block COARSE_DIRT_WALL = registerBlock("coarse_dirt_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.COARSE_DIRT), WallBlock::new);
    public static final Block ROOTED_DIRT_WALL = registerBlock("rooted_dirt_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.ROOTED_DIRT), WallBlock::new);
    public static final Block MUD_WALL = registerBlock("mud_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MUD), WallBlock::new);
    public static final Block BEDROCK_WALL = registerBlock("bedrock_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BEDROCK), WallBlock::new);

    public static final Block OAK_WOOD_WALL = registerBlock("oak_wood_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_PLANKS).mapColor(MapColor.DIRT_BROWN), WallBlock::new);
    public static final Block SPRUCE_WOOD_WALL = registerBlock("spruce_wood_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SPRUCE_PLANKS).mapColor(MapColor.BROWN), WallBlock::new);
    public static final Block BIRCH_WOOD_WALL = registerBlock("birch_wood_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BIRCH_PLANKS).mapColor(MapColor.OFF_WHITE), WallBlock::new);
    public static final Block JUNGLE_WOOD_WALL = registerBlock("jungle_wood_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.JUNGLE_PLANKS).mapColor(MapColor.DIRT_BROWN), WallBlock::new);
    public static final Block ACACIA_WOOD_WALL = registerBlock("acacia_wood_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.ACACIA_PLANKS).mapColor(MapColor.STONE_GRAY), WallBlock::new);
    public static final Block DARK_OAK_WOOD_WALL = registerBlock("dark_oak_wood_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.DARK_OAK_PLANKS), WallBlock::new);
    public static final Block MANGROVE_WOOD_WALL = registerBlock("mangrove_wood_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MANGROVE_PLANKS).mapColor(MapColor.DIRT_BROWN), WallBlock::new);
    public static final Block CHERRY_WOOD_WALL = registerBlock("cherry_wood_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CHERRY_PLANKS).mapColor(MapColor.TERRACOTTA_GRAY), WallBlock::new);
    public static final Block PALE_OAK_WOOD_WALL = registerBlock("pale_oak_wood_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PALE_OAK_PLANKS).mapColor(MapColor.STONE_GRAY), WallBlock::new);
    ...
    public static final Block WOODEN_WOOD_WALL = registerBlock("wooden_wood_wall",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.WOODEN_PLANKS).mapColor(MapColor.TERRACOTTA_BROWN), WallBlock::new);
    public static final Block IRON_CAP_HYPHAE_WALL = registerBlock("iron_cap_hyphae_wall",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.IRON_CAP_PLANKS).mapColor(MapColor.TERRACOTTA_GRAY), WallBlock::new);
    public static final Block DRIFTWOOD_LOG_WALL = registerBlock("driftwood_log_wall",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.DRIFTWOOD_PLANKS).mapColor(MapColor.LIGHT_BLUE), WallBlock::new);
    public static final Block DRIED_DRIFTWOOD_WALL = registerBlock("dried_driftwood_wall",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.DRIFTWOOD_PLANKS).mapColor(MapColor.TERRACOTTA_WHITE), WallBlock::new);

    public static final Block BAMBOO_BLOCK_WALL = registerBlock("bamboo_block_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BAMBOO_PLANKS).mapColor(MapColor.DARK_GREEN), WallBlock::new);

    public static final Block STRIPPED_OAK_WOOD_WALL = registerBlock("stripped_oak_wood_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_PLANKS), WallBlock::new);
    public static final Block STRIPPED_SPRUCE_WOOD_WALL = registerBlock("stripped_spruce_wood_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SPRUCE_PLANKS), WallBlock::new);
    public static final Block STRIPPED_BIRCH_WOOD_WALL = registerBlock("stripped_birch_wood_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BIRCH_PLANKS), WallBlock::new);
    public static final Block STRIPPED_JUNGLE_WOOD_WALL = registerBlock("stripped_jungle_wood_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.JUNGLE_PLANKS), WallBlock::new);
    public static final Block STRIPPED_ACACIA_WOOD_WALL = registerBlock("stripped_acacia_wood_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.ACACIA_PLANKS), WallBlock::new);
    ...
    public static final Block STRIPPED_MANGROVE_WOOD_WALL = registerBlock("stripped_mangrove_wood_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.MANGROVE_PLANKS), WallBlock::new);
    public static final Block STRIPPED_CHERRY_WOOD_WALL = registerBlock("stripped_cherry_wood_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CHERRY_PLANKS).mapColor(MapColor.PINK), WallBlock::new);
    public static final Block STRIPPED_PALE_OAK_WOOD_WALL = registerBlock("stripped_pale_oak_wood_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PALE_OAK_PLANKS), WallBlock::new);
    public static final Block STRIPPED_CRIMSON_HYPHAE_WALL = registerBlock("stripped_crimson_hyphae_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRIMSON_PLANKS), WallBlock::new);
    public static final Block STRIPPED_WARPED_HYPHAE_WALL = registerBlock("stripped_warped_hyphae_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.WARPED_PLANKS), WallBlock::new);
    public static final Block STRIPPED_WOODEN_WOOD_WALL = registerBlock("stripped_wooden_wood_wall",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.WOODEN_PLANKS), WallBlock::new);
    public static final Block STRIPPED_IRON_CAP_HYPHAE_WALL = registerBlock("stripped_iron_cap_hyphae_wall",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.IRON_CAP_PLANKS), WallBlock::new);
    public static final Block STRIPPED_DRIFTWOOD_WALL = registerBlock("stripped_driftwood_wall",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.DRIFTWOOD_PLANKS), WallBlock::new);
    public static final Block STRIPPED_BAMBOO_WALL = registerBlock("stripped_bamboo_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BAMBOO_PLANKS), WallBlock::new);

    public static final Block LAPIS_WALL = registerBlock("lapis_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LAPIS_BLOCK), WallBlock::new);
    public static final Block CUT_SANDSTONE_WALL = registerBlock("cut_sandstone_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CUT_SANDSTONE),WallBlock::new);
    public static final Block SMOOTH_QUARTZ_WALL = registerBlock("smooth_quartz_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMOOTH_QUARTZ),WallBlock::new);
    public static final Block SMOOTH_SANDSTONE_WALL = registerBlock("smooth_sandstone_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMOOTH_SANDSTONE),WallBlock::new);
    public static final Block SMOOTH_RED_SANDSTONE_WALL = registerBlock("smooth_red_sandstone_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMOOTH_RED_SANDSTONE),WallBlock::new);
    public static final Block SMOOTH_STONE_WALL = registerBlock("smooth_stone_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMOOTH_STONE),WallBlock::new);
    public static final Block OBSIDIAN_WALL = registerBlock("obsidian_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.OBSIDIAN),WallBlock::new);
    public static final Block PURPUR_WALL = registerBlock("purpur_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.PURPUR_BLOCK),WallBlock::new);
    public static final Block SNOW_WALL = registerBlock("snow_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SNOW_BLOCK),WallBlock::new);
    public static final Block CLAY_WALL = registerBlock("clay_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CLAY), WallBlock::new);
    public static final Block NETHERRACK_WALL = registerBlock("netherrack_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NETHERRACK),WallBlock::new);
    public static final Block SMOOTH_BASALT_WALL  = registerBlock("smooth_basalt_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMOOTH_BASALT),WallBlock::new);
    public static final Block PRISMARINE_BRICK_WALL = registerBlock("prismarine_brick_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CUT_RED_SANDSTONE),WallBlock::new);
    public static final Block DARK_PRISMARINE_WALL = registerBlock("dark_prismarine_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.DARK_PRISMARINE),WallBlock::new);
    public static final Block CRACKED_STONE_BRICK_WALL = registerBlock("cracked_stone_brick_wall",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRACKED_STONE_BRICKS),WallBlock::new);
    ...
    public static final Block HARDENED_TINTED_GLASS_PANE = registerBlock("hardened_tinted_glass_pane",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.TINTED_GLASS_PANE).strength(25.0F,100.0f)
    ...
    public static final Block HYDRATED_BRAIN_CORAL_WALL_FAN = registerDeadCoralFan("hydrated_brain_coral_wall_fan",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BRAIN_CORAL_WALL_FAN), DeadCoralWallFanBlock::new,
    ...
    public static final Block HYDRATED_BUBBLE_CORAL_WALL_FAN = registerDeadCoralFan("hydrated_bubble_coral_wall_fan",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BUBBLE_CORAL_WALL_FAN), DeadCoralWallFanBlock::new,
    ...
    public static final Block HYDRATED_FIRE_CORAL_WALL_FAN = registerDeadCoralFan("hydrated_fire_coral_wall_fan",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.FIRE_CORAL_WALL_FAN), DeadCoralWallFanBlock::new,
    ...
    public static final Block HYDRATED_HORN_CORAL_WALL_FAN = registerDeadCoralFan("hydrated_horn_coral_wall_fan",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.HORN_CORAL_WALL_FAN), DeadCoralWallFanBlock::new,
            copyLootTable(HYDRATED_HORN_CORAL_FAN, false));

    public static final Block OAK_BARREL = registerNonStationBlock("oak_barrel",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BARREL).mapColor(MapColor.OAK_TAN), OakBarrelBlock::new);
    public static final Block SPRUCE_BARREL = registerNonStationBlock("spruce_barrel",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BARREL), SpruceBarrelBlock::new);
    public static final Block BIRCH_BARREL = registerNonStationBlock("birch_barrel",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BARREL).mapColor(MapColor.PALE_YELLOW), BirchBarrelBlock::new);
    public static final Block JUNGLE_BARREL = registerNonStationBlock("jungle_barrel",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BARREL).mapColor(MapColor.DIRT_BROWN), JungleBarrelBlock::new);
    public static final Block ACACIA_BARREL = registerNonStationBlock("acacia_barrel",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BARREL).mapColor(MapColor.ORANGE), AcaciaBarrelBlock::new);
    public static final Block DARK_OAK_BARREL = registerNonStationBlock("dark_oak_barrel",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BARREL).mapColor(MapColor.BROWN),DarkOakBarrelBlock::new);
    public static final Block MANGROVE_BARREL = registerNonStationBlock("mangrove_barrel",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BARREL).mapColor(MapColor.RED),MangroveBarrelBlock::new);
    public static final Block BAMBOO_BARREL = registerNonStationBlock("bamboo_barrel",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BARREL).mapColor(MapColor.YELLOW)
    ...
    public static final Block CHERRY_BARREL = registerNonStationBlock("cherry_barrel",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BARREL).mapColor(MapColor.TERRACOTTA_WHITE)
    ...
    public static final Block PALE_OAK_BARREL = registerNonStationBlock("pale_oak_barrel",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BARREL).mapColor(MapColor.OFF_WHITE) ,PaleOakBarrelBlock::new);
    public static final Block CRIMSON_BARREL = registerNonStationBlock("crimson_barrel",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BARREL).mapColor(MapColor.DULL_PINK)
    ...
    public static final Block WARPED_BARREL = registerNonStationBlock("warped_barrel",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BARREL).mapColor(MapColor.DARK_AQUA)
    ...
    public static final Block CACTUS_BARREL = registerNonStationBlock("cactus_barrel",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BARREL).mapColor(MapColor.PALE_GREEN),CactusBarrelBlock::new);
    public static final Block DRIFTWOOD_BARREL = registerNonStationBlock("driftwood_barrel",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BARREL).mapColor(MapColor.DARK_GREEN),DriftwoodBarrelBlock::new);
    public static final Block MUSHROOM_BARREL = registerNonStationBlock("mushroom_barrel",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BARREL).mapColor(MapColor.RAW_IRON_PINK),MushroomBarrelBlock::new);
    public static final Block IRON_CAP_BARREL = registerNonStationBlock("iron_cap_barrel",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BARREL).mapColor(MapColor.LIGHT_BLUE_GRAY)
    ...
    public static final Block OAK_BOOKSHELF = registerBlock("oak_bookshelf",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BOOKSHELF).mapColor(MapColor.BROWN),Block::new);
    ...
    public static final Block BIRCH_BOOKSHELF = registerBlock("birch_bookshelf",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BOOKSHELF).mapColor(MapColor.PALE_YELLOW),Block::new);
    public static final Block JUNGLE_BOOKSHELF = registerBlock("jungle_bookshelf",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BOOKSHELF).mapColor(MapColor.DIRT_BROWN),Block::new);
    public static final Block ACACIA_BOOKSHELF = registerBlock("acacia_bookshelf",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BOOKSHELF).mapColor(MapColor.ORANGE),Block::new);
    ...
    public static final Block MANGROVE_BOOKSHELF = registerBlock("mangrove_bookshelf",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BOOKSHELF).mapColor(MapColor.RED),Block::new);
    public static final Block BAMBOO_BOOKSHELF = registerBlock("bamboo_bookshelf",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BOOKSHELF).mapColor(MapColor.YELLOW)
                    .sounds(BlockSoundGroup.BAMBOO_WOOD),Block::new);
    public static final Block CHERRY_BOOKSHELF = registerBlock("cherry_bookshelf",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BOOKSHELF).mapColor(MapColor.TERRACOTTA_WHITE)
    ...
    public static final Block PALE_OAK_BOOKSHELF = registerBlock("pale_oak_bookshelf",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BOOKSHELF).mapColor(MapColor.OFF_WHITE),Block::new);
    public static final Block CRIMSON_BOOKSHELF = registerBlock("crimson_bookshelf",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BOOKSHELF).mapColor(MapColor.DULL_PINK)
                    .sounds(BlockSoundGroup.NETHER_WOOD),Block::new);
    public static final Block WARPED_BOOKSHELF = registerBlock("warped_bookshelf",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BOOKSHELF).mapColor(MapColor.DARK_AQUA)
                    .sounds(BlockSoundGroup.NETHER_WOOD),Block::new);
    public static final Block CACTUS_BOOKSHELF = registerBlock("cactus_bookshelf",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BOOKSHELF).mapColor(MapColor.PALE_GREEN),Block::new);
    public static final Block DRIFTWOOD_BOOKSHELF = registerBlock("driftwood_bookshelf",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BOOKSHELF).mapColor(MapColor.DARK_GREEN),Block::new);
    public static final Block MUSHROOM_BOOKSHELF = registerBlock("mushroom_bookshelf",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BOOKSHELF).mapColor(MapColor.RAW_IRON_PINK), Block::new);
    public static final Block IRON_CAP_BOOKSHELF = registerBlock("iron_cap_bookshelf",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BOOKSHELF).mapColor(MapColor.LIGHT_BLUE_GRAY)
    ...
    public static final Block OAK_BOOKSHELF_SLAB = registerBlock("oak_bookshelf_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.OAK_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block SPRUCE_BOOKSHELF_SLAB = registerBlock("spruce_bookshelf_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.SPRUCE_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block BIRCH_BOOKSHELF_SLAB = registerBlock("birch_bookshelf_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.BIRCH_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block JUNGLE_BOOKSHELF_SLAB = registerBlock("jungle_bookshelf_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.JUNGLE_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block DARK_OAK_BOOKSHELF_SLAB = registerBlock("dark_oak_bookshelf_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.DARK_OAK_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block ACACIA_BOOKSHELF_SLAB = registerBlock("acacia_bookshelf_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.ACACIA_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block MANGROVE_BOOKSHELF_SLAB = registerBlock("mangrove_bookshelf_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.MANGROVE_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block CHERRY_BOOKSHELF_SLAB = registerBlock("cherry_bookshelf_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CHERRY_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block PALE_OAK_BOOKSHELF_SLAB = registerBlock("pale_oak_bookshelf_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.PALE_OAK_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block BAMBOO_BOOKSHELF_SLAB = registerBlock("bamboo_bookshelf_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.BAMBOO_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block CRIMSON_BOOKSHELF_SLAB = registerBlock("crimson_bookshelf_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CRIMSON_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block WARPED_BOOKSHELF_SLAB = registerBlock("warped_bookshelf_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.WARPED_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block CACTUS_BOOKSHELF_SLAB = registerBlock("cactus_bookshelf_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.CACTUS_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block MUSHROOM_BOOKSHELF_SLAB = registerBlock("mushroom_bookshelf_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.MUSHROOM_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block IRON_CAP_BOOKSHELF_SLAB = registerBlock("iron_cap_bookshelf_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.IRON_CAP_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block DRIFTWOOD_BOOKSHELF_SLAB = registerBlock("driftwood_bookshelf_slab",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.DRIFTWOOD_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block WOODEN_BOOKSHELF_SLAB = registerBlock("wooden_bookshelf_slab",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BOOKSHELF), SlabBlock::new);

    public static final Block DEEPSLATE_SMOKER = registerNonStationBlock("deepslate_smoker",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMOKER).mapColor(MapColor.DEEPSLATE_GRAY)
    ...
    public static final Block BLACKSTONE_SMOKER = registerNonStationBlock("blackstone_smoker",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMOKER).mapColor(MapColor.BLACK)
                    .strength(3.0f),BlackstoneSmokerBlock::new);
    public static final Block TUFF_SMOKER = registerNonStationBlock("tuff_smoker",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMOKER).mapColor(MapColor.TERRACOTTA_GRAY)
    ...
    public static final Block END_STONE_SMOKER = registerNonStationBlock("end_stone_smoker",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMOKER).mapColor(MapColor.PALE_YELLOW)
    ...
    public static final Block DEEPSLATE_BLAST_FURNACE = registerNonStationBlock("deepslate_blast_furnace",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BLAST_FURNACE).mapColor(MapColor.DEEPSLATE_GRAY)
    ...
    public static final Block BLACKSTONE_BLAST_FURNACE = registerNonStationBlock("blackstone_blast_furnace",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BLAST_FURNACE).mapColor(MapColor.BLACK)
    ...
    public static final Block TUFF_BLAST_FURNACE = registerNonStationBlock("tuff_blast_furnace",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BLAST_FURNACE).mapColor(MapColor.TERRACOTTA_GRAY)
    ...
    public static final Block END_STONE_BLAST_FURNACE = registerNonStationBlock("end_stone_blast_furnace",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.BLAST_FURNACE).mapColor(MapColor.PALE_YELLOW)
    ...
    public static final Block OAK_CARTOGRAPHY_TABLE = registerNonStationBlock("oak_cartography_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CARTOGRAPHY_TABLE),OakCartographyTableBlock::new);
    public static final Block BIRCH_CARTOGRAPHY_TABLE = registerNonStationBlock("birch_cartography_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CARTOGRAPHY_TABLE),BirchCartographyTableBlock::new);
    public static final Block SPRUCE_CARTOGRAPHY_TABLE = registerNonStationBlock("spruce_cartography_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CARTOGRAPHY_TABLE),SpruceCartographyTableBlock::new);
    public static final Block JUNGLE_CARTOGRAPHY_TABLE = registerNonStationBlock("jungle_cartography_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CARTOGRAPHY_TABLE),JungleCartographyTableBlock::new);
    public static final Block ACACIA_CARTOGRAPHY_TABLE = registerNonStationBlock("acacia_cartography_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CARTOGRAPHY_TABLE),AcaciaCartographyTableBlock::new);
    public static final Block DARK_OAK_CARTOGRAPHY_TABLE = registerNonStationBlock("dark_oak_cartography_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CARTOGRAPHY_TABLE),DarkOakCartographyTableBlock::new);
    public static final Block MANGROVE_CARTOGRAPHY_TABLE = registerNonStationBlock("mangrove_cartography_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CARTOGRAPHY_TABLE),MangroveCartographyTableBlock::new);
    public static final Block CHERRY_CARTOGRAPHY_TABLE = registerNonStationBlock("cherry_cartography_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CARTOGRAPHY_TABLE)
    ...
    public static final Block PALE_OAK_CARTOGRAPHY_TABLE = registerNonStationBlock("pale_oak_cartography_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CARTOGRAPHY_TABLE) ,PaleOakCartographyTableBlock::new);
    ...
    public static final Block CACTUS_CARTOGRAPHY_TABLE = registerNonStationBlock("cactus_cartography_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CARTOGRAPHY_TABLE),CactusCartographyTableBlock::new);
    public static final Block DRIFTWOOD_CARTOGRAPHY_TABLE = registerNonStationBlock("driftwood_cartography_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CARTOGRAPHY_TABLE),DriftwoodCartographyTableBlock::new);
    public static final Block MUSHROOM_CARTOGRAPHY_TABLE = registerNonStationBlock("mushroom_cartography_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.CARTOGRAPHY_TABLE),MushroomCartographyTableBlock::new);
    ...
    public static final Block DEEPSLATE_GRINDSTONE = registerNonStationBlock("deepslate_grindstone",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.GRINDSTONE).sounds(BlockSoundGroup.DEEPSLATE)
    ...
    public static final Block BLACKSTONE_GRINDSTONE = registerNonStationBlock("blackstone_grindstone",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.GRINDSTONE).mapColor(MapColor.BLACK),BlackstoneGrindstoneBlock::new);
    public static final Block TUFF_GRINDSTONE = registerNonStationBlock("tuff_grindstone",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.GRINDSTONE).mapColor(MapColor.TERRACOTTA_GRAY)
    ...
    public static final Block END_STONE_GRINDSTONE = registerNonStationBlock("end_stone_grindstone",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.GRINDSTONE).mapColor(MapColor.PALE_YELLOW),EndstoneGrindstoneBlock::new);

    public static final Block OAK_SMITHING_TABLE = registerNonStationBlock("oak_smithing_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMITHING_TABLE),OakSmithingTableBlock::new);
    public static final Block SPRUCE_SMITHING_TABLE = registerNonStationBlock("spruce_smithing_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMITHING_TABLE),SpruceSmithingTableBlock::new);
    public static final Block BIRCH_SMITHING_TABLE = registerNonStationBlock("birch_smithing_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMITHING_TABLE),BirchSmithingTableBlock::new);
    public static final Block JUNGLE_SMITHING_TABLE = registerNonStationBlock("jungle_smithing_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMITHING_TABLE),JungleSmithingTableBlock::new);
    public static final Block ACACIA_SMITHING_TABLE = registerNonStationBlock("acacia_smithing_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMITHING_TABLE),AcaciaSmithingTableBlock::new);
    public static final Block DARK_OAK_SMITHING_TABLE = registerNonStationBlock("dark_oak_smithing_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMITHING_TABLE),DarkOakSmithingTableBlock::new);
    public static final Block MANGROVE_SMITHING_TABLE = registerNonStationBlock("mangrove_smithing_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMITHING_TABLE),MangroveSmithingTableBlock::new);
    public static final Block CRIMSON_SMITHING_TABLE = registerNonStationBlock("crimson_smithing_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMITHING_TABLE)
    ...
    public static final Block PALE_OAK_SMITHING_TABLE = registerNonStationBlock("pale_oak_smithing_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMITHING_TABLE) , PaleOakSmithingTableBlock::new);
    public static final Block CACTUS_SMITHING_TABLE = registerNonStationBlock("cactus_smithing_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMITHING_TABLE),CactusSmithingTableBlock::new);
    public static final Block MUSHROOM_SMITHING_TABLE = registerNonStationBlock("mushroom_smithing_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMITHING_TABLE),MushroomSmithingTableBlock::new);
    public static final Block IRON_CAP_SMITHING_TABLE = registerNonStationBlock("iron_cap_smithing_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMITHING_TABLE).sounds(BlockSoundGroup.NETHER_STEM),IronCapSmithingTableBlock::new);
    public static final Block DRIFTWOOD_SMITHING_TABLE = registerNonStationBlock("driftwood_smithing_table",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.SMITHING_TABLE),DriftwoodSmithingTableBlock::new);

    public static final Block DEEPSLATE_STONECUTTER = registerNonStationBlock("deepslate_stonecutter",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.STONECUTTER).mapColor(MapColor.DEEPSLATE_GRAY)
    ...
    public static final Block BLACKSTONE_STONECUTTER = registerNonStationBlock("blackstone_stonecutter",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.STONECUTTER).mapColor(MapColor.BLACK)
    ...
    public static final Block END_STONE_STONECUTTER = registerNonStationBlock("end_stone_stonecutter",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.STONECUTTER).mapColor(MapColor.PALE_YELLOW)
    ...
    public static final Block WAXED_COPPER_SOUL_LANTERN = registerBlock("waxed_copper_soul_lantern",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.COPPER_SOUL_LANTERN),LanternBlock::new);
    ...
    public static final Block WAXED_EXPOSED_COPPER_SOUL_LANTERN = registerBlock("waxed_exposed_copper_soul_lantern",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.EXPOSED_COPPER_SOUL_LANTERN),LanternBlock::new);
    ...
    public static final Block WAXED_WEATHERED_COPPER_SOUL_LANTERN = registerBlock("waxed_weathered_copper_soul_lantern",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.WEATHERED_COPPER_SOUL_LANTERN),LanternBlock::new);
    ...
    public static final Block WAXED_OXIDIZED_COPPER_SOUL_LANTERN = registerBlock("waxed_oxidized_copper_soul_lantern",
            BlockBehaviour.Properties.ofLegacyCopy(DecoBlocks.OXIDIZED_COPPER_SOUL_LANTERN),LanternBlock::new);

    public static final Block BUBBLE_ELEVATOR_BLOCK_BUBBLE = registerBlock("bubble_elevator_block_bubble",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.WAXED_COPPER_BLOCK).resistance(25.0f)
    ...
    public static final Block STONE_LEVER = registerBlock("stone_lever",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LEVER),LeverBlock::new);
    public static final Block DEEPSLATE_LEVER = registerBlock("deepslate_lever",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LEVER).sounds(BlockSoundGroup.DEEPSLATE),LeverBlock::new);
    ...
    public static final Block POLISHED_DEEPSLATE_LEVER = registerBlock("polished_deepslate_lever",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LEVER).sounds(BlockSoundGroup.POLISHED_DEEPSLATE),LeverBlock::new);
    ...
    public static final Block TUFF_LEVER = registerBlock("tuff_lever",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LEVER).sounds(BlockSoundGroup.TUFF),LeverBlock::new);
    public static final Block POLISHED_TUFF_LEVER = registerBlock("polished_tuff_lever",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.LEVER).sounds(BlockSoundGroup.POLISHED_TUFF),LeverBlock::new);
    ...
    public static final Block OAK_NOTE_BLOCK = registerBlock("oak_note_block",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NOTE_BLOCK).mapColor(MapColor.OAK_TAN),NoteBlock::new);
    public static final Block SPRUCE_NOTE_BLOCK = registerBlock("spruce_note_block",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NOTE_BLOCK).mapColor(MapColor.SPRUCE_BROWN),NoteBlock::new);
    public static final Block BIRCH_NOTE_BLOCK = registerBlock("birch_note_block",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NOTE_BLOCK).mapColor(MapColor.PALE_YELLOW),NoteBlock::new);
    public static final Block JUNGLE_NOTE_BLOCK = registerBlock("jungle_note_block",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NOTE_BLOCK).mapColor(MapColor.DIRT_BROWN),NoteBlock::new);
    public static final Block ACACIA_NOTE_BLOCK = registerBlock("acacia_note_block",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NOTE_BLOCK).mapColor(MapColor.ORANGE),NoteBlock::new);
    public static final Block DARK_OAK_NOTE_BLOCK = registerBlock("dark_oak_note_block",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NOTE_BLOCK).mapColor(MapColor.BROWN),NoteBlock::new);
    public static final Block MANGROVE_NOTE_BLOCK = registerBlock("mangrove_note_block",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NOTE_BLOCK).mapColor(MapColor.RED),NoteBlock::new);
    public static final Block CHERRY_NOTE_BLOCK = registerBlock("cherry_note_block",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NOTE_BLOCK).mapColor(MapColor.TERRACOTTA_WHITE)
    ...
    public static final Block PALE_OAK_NOTE_BLOCK = registerBlock("pale_oak_note_block",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NOTE_BLOCK).mapColor(MapColor.WHITE),NoteBlock::new);
    public static final Block BAMBOO_NOTE_BLOCK = registerBlock("bamboo_note_block",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NOTE_BLOCK).mapColor(MapColor.YELLOW)
    ...
    public static final Block CRIMSON_NOTE_BLOCK = registerBlock("crimson_note_block",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NOTE_BLOCK).mapColor(MapColor.DULL_PINK)
    ...
    public static final Block WARPED_NOTE_BLOCK = registerBlock("warped_note_block",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NOTE_BLOCK).mapColor(MapColor.DARK_AQUA)
                    .sounds(BlockSoundGroup.NETHER_WOOD),NoteBlock::new);
    public static final Block CACTUS_NOTE_BLOCK = registerBlock("cactus_note_block",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NOTE_BLOCK).mapColor(MapColor.PALE_GREEN),NoteBlock::new);
    public static final Block MUSHROOM_NOTE_BLOCK = registerBlock("mushroom_note_block",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NOTE_BLOCK).mapColor(MapColor.RAW_IRON_PINK),NoteBlock::new);
    public static final Block IRON_CAP_NOTE_BLOCK = registerBlock("iron_cap_note_block",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NOTE_BLOCK).mapColor(MapColor.LIGHT_BLUE_GRAY)
    ...
    public static final Block DRIFTWOOD_NOTE_BLOCK = registerBlock("driftwood_note_block",
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.NOTE_BLOCK).mapColor(MapColor.DARK_GREEN)
                    .sounds(BlockSoundGroup.CHERRY_WOOD),NoteBlock::new);
    ...
    public static final WallSignBlock WALL_CACTUS_SIGN  = TerraformSignBlockHelper.registerSignBlock
            (CACTUS_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.CACTUS_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_CACTUS_SIGN.getLootTableKey()));
    ...
    public static final WallSignBlock WALL_WOODEN_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WOODEN_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.WOODEN_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_WOODEN_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_MUSHROOM_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MUSHROOM_WALL_SIGN_ID, settings -> new WallSignBlock(DecoWoodTypes.MUSHROOM_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_MUSHROOM_SIGN.getLootTableKey()));
    ...
    public static final WallSignBlock WALL_DRIFTWOOD_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DRIFTWOOD_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.DRIFTWOOD_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_DRIFTWOOD_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_CACTUS_SIGN = TerraformSignBlockHelper.registerSignBlock
            ...
            BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_CACTUS_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_MUSHROOM_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MUSHROOM_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.MUSHROOM_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_MUSHROOM_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_IRON_CAP_SIGN = TerraformSignBlockHelper.registerSignBlock
            (IRON_CAP_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.IRON_CAP_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_IRON_CAP_SIGN.getLootTableKey()));
    ...
    public static final WallHangingSignBlock WALL_HANGING_WOODEN_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WOODEN_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.WOODEN_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_WOODEN_SIGN.getLootTableKey()));
    ...
    public static final WallHangingSignBlock WALL_HANGING_DRIFTWOOD_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DRIFTWOOD_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.DRIFTWOOD_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_DRIFTWOOD_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_STRIPPED_OAK_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_OAK_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_OAK_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_OAK_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_STRIPPED_SPRUCE_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_SPRUCE_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_SPRUCE_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_SPRUCE_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_STRIPPED_BIRCH_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_BIRCH_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_BIRCH_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_BIRCH_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_STRIPPED_JUNGLE_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_JUNGLE_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_JUNGLE_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_JUNGLE_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_STRIPPED_ACACIA_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_ACACIA_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_ACACIA_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_ACACIA_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_STRIPPED_DARK_OAK_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_DARK_OAK_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_DARK_OAK_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_DARK_OAK_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_STRIPPED_MANGROVE_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_MANGROVE_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_MANGROVE_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_MANGROVE_SIGN.getLootTableKey()));
    public static final Block STANDING_STRIPPED_CHERRY_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_CHERRY_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.STRIPPED_CHERRY_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.CHERRY_SIGN));
    public static final Block WALL_STRIPPED_CHERRY_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_CHERRY_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_CHERRY_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.CHERRY_WALL_SIGN).lootTable(STANDING_STRIPPED_CHERRY_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_STRIPPED_PALE_OAK_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_PALE_OAK_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_PALE_OAK_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_PALE_OAK_SIGN.getLootTableKey()));
    public static final Block STANDING_STRIPPED_CRIMSON_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_CRIMSON_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.STRIPPED_CRIMSON_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRIMSON_SIGN));
    public static final Block WALL_STRIPPED_CRIMSON_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_CRIMSON_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_CRIMSON_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRIMSON_WALL_SIGN).lootTable(STANDING_STRIPPED_CRIMSON_SIGN.getLootTableKey()));
    public static final Block STANDING_STRIPPED_WARPED_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_WARPED_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.STRIPPED_WARPED_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.WARPED_SIGN));
    public static final Block WALL_STRIPPED_WARPED_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_WARPED_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_WARPED_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.WARPED_WALL_SIGN).lootTable(STANDING_STRIPPED_WARPED_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_STRIPPED_WOODEN_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_WOODEN_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_WOODEN_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_WOODEN_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_STRIPPED_DRIFTWOOD_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_DRIFTWOOD_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_DRIFTWOOD_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_DRIFTWOOD_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_STRIPPED_CACTUS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_CACTUS_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_CACTUS_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_CACTUS_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_MUSHROOM_STEM_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MUSHROOM_STEM_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.MUSHROOM_STEM_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_MUSHROOM_STEM_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_STRIPPED_IRON_CAP_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_IRON_CAP_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_IRON_CAP_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_IRON_CAP_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_OAK_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (OAK_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.OAK_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_OAK_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_SPRUCE_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (SPRUCE_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.SPRUCE_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_SPRUCE_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_BIRCH_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (BIRCH_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.BIRCH_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_BIRCH_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_JUNGLE_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (JUNGLE_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.JUNGLE_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_JUNGLE_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_ACACIA_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (ACACIA_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.ACACIA_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_ACACIA_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_DARK_OAK_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DARK_OAK_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.DARK_OAK_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_DARK_OAK_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_MANGROVE_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MANGROVE_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.MANGROVE_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_MANGROVE_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_CHERRY_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CHERRY_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.CHERRY_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.CHERRY_WALL_SIGN).lootTable(STANDING_CHERRY_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_PALE_OAK_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (PALE_OAK_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.PALE_OAK_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_PALE_OAK_MOSAIC_SIGN.getLootTableKey()));
    public static final Block STANDING_BAMBOO_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (BAMBOO_MOSAIC_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.BAMBOO_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.BAMBOO_SIGN));
    public static final Block WALL_BAMBOO_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (BAMBOO_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.BAMBOO_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.BAMBOO_WALL_SIGN).lootTable(STANDING_BAMBOO_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_CRIMSON_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CRIMSON_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.CRIMSON_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRIMSON_WALL_SIGN).lootTable(STANDING_CRIMSON_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_WARPED_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WARPED_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.WARPED_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.WARPED_WALL_SIGN).lootTable(STANDING_WARPED_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_CACTUS_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CACTUS_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.CACTUS_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_CACTUS_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_WOODEN_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WOODEN_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.WOODEN_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_WOODEN_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_DRIFTWOOD_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DRIFTWOOD_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.DRIFTWOOD_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_DRIFTWOOD_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_MUSHROOM_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MUSHROOM_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.MUSHROOM_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_MUSHROOM_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_IRON_CAP_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (IRON_CAP_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.IRON_CAP_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_IRON_CAP_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_OAK_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (OAK_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.OAK_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_OAK_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_SPRUCE_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (SPRUCE_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.SPRUCE_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_SPRUCE_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_BIRCH_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (BIRCH_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.BIRCH_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_BIRCH_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_JUNGLE_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (JUNGLE_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.JUNGLE_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_JUNGLE_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_ACACIA_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (ACACIA_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.ACACIA_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_ACACIA_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_DARK_OAK_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DARK_OAK_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.DARK_OAK_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_DARK_OAK_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_MANGROVE_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MANGROVE_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.MANGROVE_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_MANGROVE_MOSAIC_SIGN.getLootTableKey()));
    public static final Block HANGING_CHERRY_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CHERRY_MOSAIC_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.CHERRY_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.CHERRY_HANGING_SIGN));
    public static final Block WALL_HANGING_CHERRY_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CHERRY_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.CHERRY_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.CHERRY_WALL_HANGING_SIGN).lootTable(HANGING_CHERRY_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_PALE_OAK_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (PALE_OAK_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.PALE_OAK_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_PALE_OAK_MOSAIC_SIGN.getLootTableKey()));
    public static final Block HANGING_BAMBOO_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (BAMBOO_MOSAIC_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.BAMBOO_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.BAMBOO_HANGING_SIGN));
    public static final Block WALL_HANGING_BAMBOO_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (BAMBOO_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.BAMBOO_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.BAMBOO_WALL_HANGING_SIGN).lootTable(HANGING_BAMBOO_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_CRIMSON_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CRIMSON_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.CRIMSON_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRIMSON_WALL_HANGING_SIGN).lootTable(HANGING_CRIMSON_MOSAIC_SIGN.getLootTableKey()));
    public static final Block HANGING_WARPED_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WARPED_MOSAIC_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.WARPED_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.WARPED_HANGING_SIGN));
    public static final Block WALL_HANGING_WARPED_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WARPED_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.WARPED_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.WARPED_WALL_HANGING_SIGN).lootTable(HANGING_WARPED_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_CACTUS_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CACTUS_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.CACTUS_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_CACTUS_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_WOODEN_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WOODEN_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.WOODEN_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_WOODEN_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_DRIFTWOOD_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DRIFTWOOD_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.DRIFTWOOD_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_DRIFTWOOD_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_MUSHROOM_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MUSHROOM_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.MUSHROOM_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_MUSHROOM_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_IRON_CAP_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (IRON_CAP_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.IRON_CAP_MOSAIC_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_IRON_CAP_MOSAIC_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_OAK_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (OAK_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.OAK_PLANKS_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_OAK_PLANKS_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_SPRUCE_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (SPRUCE_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.SPRUCE_PLANKS_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_SPRUCE_PLANKS_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_BIRCH_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (BIRCH_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.BIRCH_PLANKS_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_BIRCH_PLANKS_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_JUNGLE_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (JUNGLE_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.JUNGLE_PLANKS_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_JUNGLE_PLANKS_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_ACACIA_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (ACACIA_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.ACACIA_PLANKS_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_ACACIA_PLANKS_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_DARK_OAK_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DARK_OAK_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.DARK_OAK_PLANKS_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_DARK_OAK_PLANKS_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_MANGROVE_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MANGROVE_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.MANGROVE_PLANKS_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_MANGROVE_PLANKS_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_CHERRY_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CHERRY_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.CHERRY_PLANKS_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.CHERRY_WALL_HANGING_SIGN).lootTable(HANGING_CHERRY_PLANKS_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_PALE_OAK_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (PALE_OAK_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.PALE_OAK_PLANKS_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_PALE_OAK_PLANKS_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_CRIMSON_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CRIMSON_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.CRIMSON_PLANKS_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.CRIMSON_WALL_HANGING_SIGN).lootTable(HANGING_CRIMSON_PLANKS_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_WARPED_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WARPED_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.WARPED_PLANKS_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.WARPED_WALL_HANGING_SIGN).lootTable(HANGING_WARPED_PLANKS_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_CACTUS_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CACTUS_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.CACTUS_PLANKS_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_CACTUS_PLANKS_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_WOODEN_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WOODEN_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.WOODEN_PLANKS_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_WOODEN_PLANKS_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_DRIFTWOOD_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DRIFTWOOD_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.DRIFTWOOD_PLANKS_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_DRIFTWOOD_PLANKS_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_IRON_CAP_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (IRON_CAP_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.IRON_CAP_PLANKS_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_IRON_CAP_PLANKS_SIGN.getLootTableKey()));
    ...
    public static final Block WALL_HANGING_MUSHROOM_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MUSHROOM_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.MUSHROOM_PLANKS_TYPE, settings),
                    BlockBehaviour.Properties.ofLegacyCopy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_MUSHROOM_PLANKS_SIGN.getLootTableKey()));
    ...
    public static <T extends Block> T registerBlock(String name,final BlockBehaviour.Properties properties, Function<BlockBehaviour.Properties, T> factory){
        T block = factory.apply(properties.registryKey(getBlockKey(name)));
        registerBlockItem(name, block);
        return Registry.register(Registries.BLOCK, getBlockKey(name), block);
    }
    public static <T extends Block> T registerNonStationBlock(String name,final BlockBehaviour.Properties properties, Function<BlockBehaviour.Properties, T> factory){
        T block = factory.apply(properties.registryKey(getBlockKey(name)));
        registerNonStationBlockItem(name, block);
        return Registry.register(Registries.BLOCK, getBlockKey(name), block);
    }
    public static <T extends Block> T registerCouldBlock(String name,final BlockBehaviour.Properties properties, Function<BlockBehaviour.Properties, T> factory){
        T block = factory.apply(properties.registryKey(getBlockKey(name)));
        registerCloudBlockItem(name, block);
        return Registry.register(Registries.BLOCK, getCloudBlockKey(name), block);
    }
    public static <T extends Block> T registerBlockWithoutItem(String name,final BlockBehaviour.Properties properties, Function<AbstractBlock.Settings, T> factory){
        T block = factory.apply(settings.registryKey(getBlockKey(name)));
        return Registry.register(Registries.BLOCK, getBlockKey(name), block);
    }
    public static <T extends Block> T registerDeadCoralFan(String name, final BlockBehaviour.Properties properties, Function<AbstractBlock.Settings, T> factory, AbstractBlock.Settings copyLootTable){
        T block = factory.apply(settings.registryKey(getBlockKey(name)));
        return Registry.register(Registries.BLOCK, getBlockKey(name), block);
    }
    ...
    public static StairsBlock registerStairs(String name, Block block, Block copyBlock){
        return registerSimple(name, new StairsBlock(block.getDefaultState(),
                BlockBehaviour.Properties.ofLegacyCopy(copyBlock).registryKey(DecoBlocks.getBlockKey(name))));
    }
    public static StairsBlock registerWoodStairs(String name, Block block, Block copyBlock, MapColor mapColor){
        return registerSimple(name, new StairsBlock(block.getDefaultState(),
                BlockBehaviour.Properties.ofLegacyCopy(copyBlock).mapColor(mapColor).registryKey(DecoBlocks.getBlockKey(name))));
    }
    ...
    public static OxidizableLadderBlock registerOxidLadder(String name, Oxidizable.OxidationLevel oxidationLevel, Block copyBlock){
        return registerSimple(name, new OxidizableLadderBlock(oxidationLevel,
                BlockBehaviour.Properties.ofLegacyCopy(copyBlock).sounds(BlockSoundGroup.COPPER).strength(5.0F, 6.0F)
    ...
    public static InfestedBlock registerInfestedBlock(String name, Block block, Block copyBlock,float strength, float blastRes){
        return registerSimple(name, new InfestedBlock(block.getDefaultState().getBlock(),
                BlockBehaviour.Properties.ofLegacyCopy(copyBlock).strength(strength).resistance(blastRes)
    ...
    public static DriftwoodSaplingBlock registerDriftwoodSapling(String name, SaplingGenerator generator, Block copyBlock) {
        return registerSimple(name, new DriftwoodSaplingBlock(generator,
                BlockBehaviour.Properties.ofLegacyCopy(copyBlock).registryKey(DecoBlocks.getBlockKey(name)).ticksRandomly()));
    }
    public static IronCapBlock registerIronCap(String name, SaplingGenerator generator, Block copyBlock) {
        return registerSimple(name, new IronCapBlock(generator,
                BlockBehaviour.Properties.ofLegacyCopy(copyBlock).mapColor(MapColor.IRON_GRAY).registryKey(DecoBlocks.getBlockKey(name))));
    }
    public static OxidizablePaneBlock registerOxidPane(String name, Oxidizable.OxidationLevel oxidationLevel, Block copyBlock) {
        return registerSimple(name, new OxidizablePaneBlock(oxidationLevel,
                BlockBehaviour.Properties.ofLegacyCopy(copyBlock).sounds(BlockSoundGroup.COPPER).registryKey(DecoBlocks.getBlockKey(name))));
    }
    ...
    public static DoorBlock registerDoorBlock(String name, BlockSetType blockSetType, Block copyBlock) {
        return registerSimple(name, new DoorBlock(blockSetType,
                BlockBehaviour.Properties.ofLegacyCopy(copyBlock).nonOpaque().registryKey(DecoBlocks.getBlockKey(name))));
    }
    ...
    private static AbstractBlock.Settings copyLootTable(Block block, boolean copyTranslationKey) {
        final BlockBehaviour.Properties properties = block.getSettings();
        final BlockBehaviour.Properties properties2 = AbstractBlock.Settings.create().lootTable(block.getLootTableKey());
