...
public class MangroveCartographyTableScreenHandler extends AbstractContainerMenu {
	...
	public final Container inventory = new SimpleContainer(2) {
		...
		public void setChanged() {
			MangroveCartographyTableScreenHandler.this.slotsChanged(this);
			super.setChanged();
		}
	};
	...
	public MangroveCartographyTableScreenHandler(int syncId, Inventory inventory) {
		this(syncId, inventory, ContainerLevelAccess.NULL);
	}

	public MangroveCartographyTableScreenHandler(int syncId, Inventory inventory, ContainerLevelAccess context) {
		...
		this.addSlot(new Slot(this.resultInventory, 2, 145, 39) {
			...
			public void onTake(Player player, ItemStack stack) {
				MangroveCartographyTableScreenHandler.this.slots.get(0).remove(1);
				MangroveCartographyTableScreenHandler.this.slots.get(1).remove(1);
	...
	public boolean stillValid(Player player) {
		return stillValid(this.context, player, DecoBlocks.MANGROVE_CARTOGRAPHY_TABLE);
	}
