...
public class AcaciaSmithingMenu extends ItemCombinerMenu {
    ...
    public AcaciaSmithingMenu(final int containerId, final Inventory inventory) {
        this(containerId, inventory, ContainerLevelAccess.NULL);
    }

    public AcaciaSmithingMenu(final int containerId, final Inventory inventory, final ContainerLevelAccess access) {
        this(containerId, inventory, access, inventory.player.level());
    }

    private AcaciaSmithingMenu(final int containerId, final Inventory inventory, final ContainerLevelAccess access, final Level level) {
    ...
    protected boolean isValidBlock(final BlockState state) {
        return state.is(DecoBlocks.ACACIA_SMITHING_TABLE);
    }
