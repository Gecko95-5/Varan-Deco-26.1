...
public class JungleSmithingMenu extends ItemCombinerMenu {
    ...
    public JungleSmithingMenu(final int containerId, final Inventory inventory) {
        this(containerId, inventory, ContainerLevelAccess.NULL);
    }

    public JungleSmithingMenu(final int containerId, final Inventory inventory, final ContainerLevelAccess access) {
        this(containerId, inventory, access, inventory.player.level());
    }

    private JungleSmithingMenu(final int containerId, final Inventory inventory, final ContainerLevelAccess access, final Level level) {
    ...
    protected boolean isValidBlock(final BlockState state) {
        return state.is(DecoBlocks.JUNGLE_SMITHING_TABLE);
    }
