...
public class OakSmithingMenu extends ItemCombinerMenu {
    ...
    public OakSmithingMenu(final int containerId, final Inventory inventory) {
        this(containerId, inventory, ContainerLevelAccess.NULL);
    }

    public OakSmithingMenu(final int containerId, final Inventory inventory, final ContainerLevelAccess access) {
        this(containerId, inventory, access, inventory.player.level());
    }

    private OakSmithingMenu(final int containerId, final Inventory inventory, final ContainerLevelAccess access, final Level level) {
    ...
    protected boolean isValidBlock(final BlockState state) {
        return state.is(DecoBlocks.OAK_SMITHING_TABLE);
    }
