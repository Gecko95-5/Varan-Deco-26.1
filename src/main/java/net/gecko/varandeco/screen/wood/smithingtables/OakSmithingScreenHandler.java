...
public class OakSmithingScreenHandler extends ItemCombinerMenu {
	...
	public OakSmithingScreenHandler(int syncId, Inventory playerInventory) {
		this(syncId, playerInventory, ContainerLevelAccess.NULL);
	}

	public OakSmithingScreenHandler(int syncId, Inventory playerInventory, ContainerLevelAccess context) {
		this(syncId, playerInventory, context, playerInventory.player.level());
	}

	private OakSmithingScreenHandler(int syncId, Inventory playerInventory, ContainerLevelAccess context, Level world) {
