...
public class PaleOakSmithingScreenHandler extends ItemCombinerMenu {
	...
	public PaleOakSmithingScreenHandler(int syncId, Inventory playerInventory) {
		this(syncId, playerInventory, ContainerLevelAccess.NULL);
	}

	public PaleOakSmithingScreenHandler(int syncId, Inventory playerInventory, ContainerLevelAccess context) {
		this(syncId, playerInventory, context, playerInventory.player.level());
	}

	private PaleOakSmithingScreenHandler(int syncId, Inventory playerInventory, ContainerLevelAccess context, Level world) {
