...
public class IronCapCartographyTableScreenHandler extends AbstractContainerMenu {
	...
	public final Container inventory = new SimpleContainer(2) {
		...
		public void setChanged() {
			IronCapCartographyTableScreenHandler.this.slotsChanged(this);
			super.setChanged();
		}
	};
	...
	public IronCapCartographyTableScreenHandler(int syncId, Inventory inventory) {
		this(syncId, inventory, ContainerLevelAccess.NULL);
	}

	public IronCapCartographyTableScreenHandler(int syncId, Inventory inventory, ContainerLevelAccess context) {
		...
		this.addSlot(new Slot(this.resultInventory, 2, 145, 39) {
			...
			public void onTake(Player player, ItemStack stack) {
				IronCapCartographyTableScreenHandler.this.slots.get(0).remove(1);
				IronCapCartographyTableScreenHandler.this.slots.get(1).remove(1);
	...
	public boolean stillValid(Player player) {
		return stillValid(this.context, player, DecoBlocks.IRON_CAP_CARTOGRAPHY_TABLE);
	}
