...
public class SpruceSmithingMenu extends ItemCombinerMenu {
    ...
    public SpruceSmithingMenu(final int containerId, final Inventory inventory) {
        this(containerId, inventory, ContainerLevelAccess.NULL);
    }

    public SpruceSmithingMenu(final int containerId, final Inventory inventory, final ContainerLevelAccess access) {
        this(containerId, inventory, access, inventory.player.level());
    }

    private SpruceSmithingMenu(final int containerId, final Inventory inventory, final ContainerLevelAccess access, final Level level) {
    ...
    protected boolean isValidBlock(final BlockState state) {
        return state.is(DecoBlocks.SPRUCE_SMITHING_TABLE);
    }
