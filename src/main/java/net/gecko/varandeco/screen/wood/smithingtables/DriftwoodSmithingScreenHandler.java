...
public class DriftwoodSmithingScreenHandler extends ItemCombinerMenu {
	...
	public DriftwoodSmithingScreenHandler(int syncId, Inventory playerInventory, ContainerLevelAccess context) {
		this(syncId, playerInventory, context, playerInventory.player.level());
	}

	private DriftwoodSmithingScreenHandler(int syncId, Inventory playerInventory, ContainerLevelAccess context, Level world) {
