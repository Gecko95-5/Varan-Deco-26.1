...
public class DarkOakSmithingMenu extends ItemCombinerMenu {
    ...
    public DarkOakSmithingMenu(final int containerId, final Inventory inventory) {
        this(containerId, inventory, ContainerLevelAccess.NULL);
    }

    public DarkOakSmithingMenu(final int containerId, final Inventory inventory, final ContainerLevelAccess access) {
        this(containerId, inventory, access, inventory.player.level());
    }

    private DarkOakSmithingMenu(final int containerId, final Inventory inventory, final ContainerLevelAccess access, final Level level) {
    ...
    protected boolean isValidBlock(final BlockState state) {
        return state.is(DecoBlocks.DARK_OAK_SMITHING_TABLE);
    }
