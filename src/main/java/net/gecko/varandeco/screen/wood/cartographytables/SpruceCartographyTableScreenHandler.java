...
public class SpruceCartographyTableScreenHandler extends AbstractContainerMenu {
	...
	public final Container inventory = new SimpleContainer(2) {
		...
		public void setChanged() {
			SpruceCartographyTableScreenHandler.this.slotsChanged(this);
			super.setChanged();
		}
	};
	...
	public SpruceCartographyTableScreenHandler(int syncId, Inventory inventory) {
		this(syncId, inventory, ContainerLevelAccess.NULL);
	}

	public SpruceCartographyTableScreenHandler(int syncId, Inventory inventory, ContainerLevelAccess context) {
		...
		this.addSlot(new Slot(this.resultInventory, 2, 145, 39) {
			...
			public void onTake(Player player, ItemStack stack) {
				SpruceCartographyTableScreenHandler.this.slots.get(0).remove(1);
				SpruceCartographyTableScreenHandler.this.slots.get(1).remove(1);
	...
	public boolean stillValid(Player player) {
		return stillValid(this.context, player, DecoBlocks.SPRUCE_CARTOGRAPHY_TABLE);
	}
