...
public class EndstoneStonecutterScreenHandler extends AbstractContainerMenu {
    ...
    public final Container input = new SimpleContainer(1) {
        ...
        public void setChanged() {
            super.setChanged();
            EndstoneStonecutterScreenHandler.this.slotsChanged(this);
            EndstoneStonecutterScreenHandler.this.contentsChangedListener.run();
        }
    };
    final ResultContainer output = new ResultContainer();

    public EndstoneStonecutterScreenHandler(int syncId, Inventory playerInventory) {
        this(syncId, playerInventory, ContainerLevelAccess.NULL);
    }

    public EndstoneStonecutterScreenHandler(int syncId, Inventory playerInventory, ContainerLevelAccess context) {
        ...
        this.outputSlot = this.addSlot(new Slot(this.output, 1, 143, 33) {
            ...
            public void onTake(Player player, ItemStack stack) {
                ...
                EndstoneStonecutterScreenHandler.this.output.awardUsedRecipes(player, this.getInputStacks());
                ItemStack itemStack = EndstoneStonecutterScreenHandler.this.inputSlot.remove(1);
            ...
            private List<ItemStack> getInputStacks() {
                return List.of(EndstoneStonecutterScreenHandler.this.inputSlot.getItem());
            }
        });
    ...
    public boolean stillValid(Player player) {
        return stillValid(this.context, player, DecoBlocks.END_STONE_STONECUTTER);
    }
