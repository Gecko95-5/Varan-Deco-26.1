...
public class DeepslateGrindstoneMenu extends AbstractContainerMenu {
    ...
    private final Container repairSlots = new SimpleContainer(2) {
        {
            Objects.requireNonNull(DeepslateGrindstoneMenu.this);
        }

        @Override
        public void setChanged() {
            super.setChanged();
            DeepslateGrindstoneMenu.this.slotsChanged(this);
        }
    };
    private final ContainerLevelAccess access;

    public DeepslateGrindstoneMenu(final int containerId, final Inventory inventory) {
        this(containerId, inventory, ContainerLevelAccess.NULL);
    }

    public DeepslateGrindstoneMenu(final int containerId, final Inventory inventory, final ContainerLevelAccess access) {
        ...
        this.addSlot(new Slot(this.resultSlots, 2, 129, 34) {
            ...
            public void onTake(final Player player, final ItemStack carried) {
                ...
                DeepslateGrindstoneMenu.this.repairSlots.setItem(0, ItemStack.EMPTY);
                DeepslateGrindstoneMenu.this.repairSlots.setItem(1, ItemStack.EMPTY);
            }

            private int getExperienceAmount(final Level level) {
                int amount = 0;
                amount += this.getExperienceFromItem(DeepslateGrindstoneMenu.this.repairSlots.getItem(0));
                amount += this.getExperienceFromItem(DeepslateGrindstoneMenu.this.repairSlots.getItem(1));
                if (amount > 0) {
    ...
    public boolean stillValid(final Player player) {
        return stillValid(this.access, player, DecoBlocks.DEEPSLATE_GRINDSTONE);
    }
