...
public class DeepslateStonecutterScreenHandler extends AbstractContainerMenu {
	...
	public final Container input = new SimpleContainer(1) {
		...
		public void setChanged() {
			super.setChanged();
			DeepslateStonecutterScreenHandler.this.slotsChanged(this);
			DeepslateStonecutterScreenHandler.this.contentsChangedListener.run();
		}
	};
	final ResultContainer output = new ResultContainer();

	public DeepslateStonecutterScreenHandler(int syncId, Inventory playerInventory) {
		this(syncId, playerInventory, ContainerLevelAccess.NULL);
	}

	public DeepslateStonecutterScreenHandler(int syncId, Inventory playerInventory, ContainerLevelAccess context) {
		...
		this.outputSlot = this.addSlot(new Slot(this.output, 1, 143, 33) {
			...
			public void onTake(Player player, ItemStack stack) {
				...
				DeepslateStonecutterScreenHandler.this.output.awardUsedRecipes(player, this.getInputStacks());
				ItemStack itemStack = DeepslateStonecutterScreenHandler.this.inputSlot.remove(1);
			...
			private List<ItemStack> getInputStacks() {
				return List.of(DeepslateStonecutterScreenHandler.this.inputSlot.getItem());
			}
		});
	...
	public boolean stillValid(Player player) {
		return stillValid(this.context, player, DecoBlocks.DEEPSLATE_STONECUTTER);
	}
