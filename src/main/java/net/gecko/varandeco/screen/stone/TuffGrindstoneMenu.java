...
public class TuffGrindstoneMenu extends AbstractContainerMenu {
    ...
    private final Container repairSlots = new SimpleContainer(2) {
        {
            Objects.requireNonNull(TuffGrindstoneMenu.this);
        }

        @Override
        public void setChanged() {
            super.setChanged();
            TuffGrindstoneMenu.this.slotsChanged(this);
        }
    };
    private final ContainerLevelAccess access;

    public TuffGrindstoneMenu(final int containerId, final Inventory inventory) {
        this(containerId, inventory, ContainerLevelAccess.NULL);
    }

    public TuffGrindstoneMenu(final int containerId, final Inventory inventory, final ContainerLevelAccess access) {
        ...
        this.addSlot(new Slot(this.resultSlots, 2, 129, 34) {
            ...
            public void onTake(final Player player, final ItemStack carried) {
                ...
                TuffGrindstoneMenu.this.repairSlots.setItem(0, ItemStack.EMPTY);
                TuffGrindstoneMenu.this.repairSlots.setItem(1, ItemStack.EMPTY);
            }

            private int getExperienceAmount(final Level level) {
                int amount = 0;
                amount += this.getExperienceFromItem(TuffGrindstoneMenu.this.repairSlots.getItem(0));
                amount += this.getExperienceFromItem(TuffGrindstoneMenu.this.repairSlots.getItem(1));
                if (amount > 0) {
    ...
    public boolean stillValid(final Player player) {
        return stillValid(this.access, player, DecoBlocks.TUFF_GRINDSTONE);
    }
