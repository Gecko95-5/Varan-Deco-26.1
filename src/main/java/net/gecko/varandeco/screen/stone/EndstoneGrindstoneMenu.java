...
public class EndstoneGrindstoneMenu extends AbstractContainerMenu {
    ...
    private final Container repairSlots = new SimpleContainer(2) {
        {
            Objects.requireNonNull(EndstoneGrindstoneMenu.this);
        }

        @Override
        public void setChanged() {
            super.setChanged();
            EndstoneGrindstoneMenu.this.slotsChanged(this);
        }
    };
    private final ContainerLevelAccess access;

    public EndstoneGrindstoneMenu(final int containerId, final Inventory inventory) {
        this(containerId, inventory, ContainerLevelAccess.NULL);
    }

    public EndstoneGrindstoneMenu(final int containerId, final Inventory inventory, final ContainerLevelAccess access) {
        ...
        this.addSlot(new Slot(this.resultSlots, 2, 129, 34) {
            ...
            public void onTake(final Player player, final ItemStack carried) {
                ...
                EndstoneGrindstoneMenu.this.repairSlots.setItem(0, ItemStack.EMPTY);
                EndstoneGrindstoneMenu.this.repairSlots.setItem(1, ItemStack.EMPTY);
            }

            private int getExperienceAmount(final Level level) {
                int amount = 0;
                amount += this.getExperienceFromItem(EndstoneGrindstoneMenu.this.repairSlots.getItem(0));
                amount += this.getExperienceFromItem(EndstoneGrindstoneMenu.this.repairSlots.getItem(1));
                if (amount > 0) {
    ...
    public boolean stillValid(final Player player) {
        return stillValid(this.access, player, DecoBlocks.END_STONE_GRINDSTONE);
    }
