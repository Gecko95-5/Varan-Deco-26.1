...
public class DecoRecipeGenerator extends FabricRecipeProvider {
  ...
  @Override
    ...
    offerBasicStairSlabWallRecipes(output, Items.CALCITE, DecoBlocks.CALCITE_STAIRS,
        DecoBlocks.CALCITE_SLAB, DecoBlocks.CALCITE_WALL);

    offerBasicStairSlabWallRecipes(output, Items.DRIPSTONE_BLOCK, DecoBlocks.DRIPSTONE_STAIRS,
    ...
    offerBasicStairSlabWallRecipes(output, DecoBlocks.POLISHED_STONE, DecoBlocks.POLISHED_STONE_STAIRS,
    ...
    offerBasicStairSlabWallRecipes(output, DecoBlocks.STONE_TILES, DecoBlocks.STONE_TILE_STAIRS,
    ...
    offerBasicStairSlabWallRecipes(output, Items.NETHERRACK, DecoBlocks.NETHERRACK_STAIRS,
        DecoBlocks.NETHERRACK_SLAB, DecoBlocks.NETHERRACK_WALL);

    offerBasicStairSlabWallRecipes(output, Items.MAGMA_BLOCK, DecoBlocks.MAGMA_STAIRS,
    ...
    offerBasicStairSlabWallRecipes(output, DecoBlocks.MAGMA_BRICKS, DecoBlocks.MAGMA_BRICK_STAIRS,
    ...
    offerBasicStairSlabWallRecipes(output, DecoBlocks.POLISHED_BLACKSTONE_TILES, DecoBlocks.POLISHED_BLACKSTONE_TILE_STAIRS,
    ...
    offerBasicStairSlabWallRecipes(output, Items.PACKED_ICE, DecoBlocks.PACKED_ICE_STAIRS,
        DecoBlocks.PACKED_ICE_SLAB, DecoBlocks.PACKED_ICE_WALL);

    offerBasicStairSlabWallRecipes(output, Items.BLUE_ICE, DecoBlocks.BLUE_ICE_STAIRS,
    ...
    offerBasicStairSlabWallRecipes(output, DecoBlocks.ICE_BRICKS, DecoBlocks.ICE_BRICK_STAIRS,
    ...
    offerBasicStairSlabWallRecipes(output, DecoBlocks.CUT_SANDSTONE_BRICKS, DecoBlocks.CUT_SANDSTONE_BRICK_STAIRS,
    ...
    stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_SANDSTONE_BRICK_SLAB, Items.SANDSTONE,2);
    stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_SANDSTONE_BRICK_SLAB, Items.CUT_SANDSTONE,2);
    ...
    offerBasicStairSlabWallRecipes(output, DecoBlocks.CUT_RED_SANDSTONE_BRICKS, DecoBlocks.CUT_RED_SANDSTONE_BRICK_STAIRS,
    ...
    stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_RED_SANDSTONE_BRICK_SLAB, Items.RED_SANDSTONE,2);
    stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_RED_SANDSTONE_BRICK_SLAB, Items.CUT_RED_SANDSTONE,2);
    ...
    offerBasicStairSlabWallRecipes(output, DecoBlocks.CRYSTALLIZED_PRISMARINE, DecoBlocks.CRYSTALLIZED_PRISMARINE_STAIRS,
    ...
    shaped(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CHISELED_CRYSTALLIZED_PRISMARINE_BRICKS,4)
        .pattern(" # ")
        .pattern("#I#")
        .pattern(" # ")
    ...
    shaped(RecipeCategory.BUILDING_BLOCKS,Items.WARPED_WART_BLOCK)
        ...
        chiseled(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CHISELED_RED_NETHER_BRICKS, Items.RED_NETHER_BRICK_SLAB);
    ...
    shaped(RecipeCategory.REDSTONE,DecoBlocks.BLUE_NETHER_BRICK_FENCE_GATE)
        ...
        chiseled(RecipeCategory.BUILDING_BLOCKS,DecoBlocks.CHISELED_BLUE_NETHER_BRICKS, DecoBlocks.BLUE_NETHER_BRICK_SLAB);
    ...
    offerPillarBlockRecipe(output,DecoBlocks.OBSIDIAN_PILLAR, DecoBlocks.OBSIDIAN_SLAB);
    ...
    shapeless(RecipeCategory.BUILDING_BLOCKS,DecoBlocks.COBBLED_SOUL_SOILSTONE,4)
    ...
    public void  offerLadderVariantRecipe(RecipeOutput exporter, ItemLike output, ItemLike woodInput) {
            ...
            public void offerBasicStairSlabWallRecipes(
                ...
                stairBuilder(stair, Ingredient.of(blockInput))
                        ...
                        .save(exporter, (getSimpleRecipeName(stair)));
            ...
            public void offerPillarBlockRecipe(RecipeOutput exporter, ItemLike output, ItemLike input) {
                shaped(RecipeCategory.BUILDING_BLOCKS, output)
                        ...
                        .pattern("#")
                        .unlockedBy(getHasName(input), has(input))
                        .save(exporter, (getSimpleRecipeName(output)));
            }
        };
    }
