...
public class DecoModelProvider extends FabricModelProvider {
    ...
    private static final Identifier GRASS_BASE_TEXTURE = Identifier.fromNamespaceAndPath("minecraft", "block/grass_block_base");
    private static final ModelTemplate CUBE_ALL_TINTED = new ModelTemplate(Optional.of(Identifier.fromNamespaceAndPath("minecraft", "block/cube_all_tinted")), Optional.empty(), TextureSlot.ALL);
    private static final ModelTemplate SLAB_TINTED = new ModelTemplate(Optional.of(Identifier.fromNamespaceAndPath("minecraft", "block/slab_tinted")), Optional.empty(), TextureSlot.BOTTOM, TextureSlot.TOP, TextureSlot.SIDE);
    private static final ModelTemplate SLAB_TOP_TINTED = new ModelTemplate(Optional.of(Identifier.fromNamespaceAndPath("minecraft", "block/slab_top_tinted")), Optional.empty(), TextureSlot.BOTTOM, TextureSlot.TOP, TextureSlot.SIDE);
    private static final ModelTemplate STAIRS_TINTED = new ModelTemplate(Optional.of(Identifier.fromNamespaceAndPath("minecraft", "block/stairs_tinted")), Optional.empty(), TextureSlot.BOTTOM, TextureSlot.TOP, TextureSlot.SIDE);
    private static final ModelTemplate STAIRS_INNER_TINTED = new ModelTemplate(Optional.of(Identifier.fromNamespaceAndPath("minecraft", "block/stairs_inner_tinted")), Optional.empty(), TextureSlot.BOTTOM, TextureSlot.TOP, TextureSlot.SIDE);
    private static final ModelTemplate STAIRS_OUTER_TINTED = new ModelTemplate(Optional.of(Identifier.fromNamespaceAndPath("minecraft", "block/stairs_outer_tinted")), Optional.empty(), TextureSlot.BOTTOM, TextureSlot.TOP, TextureSlot.SIDE);
    private static final ModelTemplate CARPET_TINTED = new ModelTemplate(Optional.of(Identifier.fromNamespaceAndPath("minecraft", "block/carpet_tinted")), Optional.empty(), TextureSlot.WOOL);
    //
