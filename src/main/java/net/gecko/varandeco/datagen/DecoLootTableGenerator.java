...
public class DecoLootTableGenerator extends FabricBlockLootSubProvider {
    ...
    public void generate() {
        ...
        dropSelf(DecoBlocks.COPPER_TULIP);
        createPotFlowerItemTable(DecoBlocks.POTTED_COPPER_TULIP);

        dropSelf(DecoBlocks.EXPOSED_COPPER_TULIP);
        createPotFlowerItemTable(DecoBlocks.POTTED_EXPOSED_COPPER_TULIP);

        dropSelf(DecoBlocks.WEATHERED_COPPER_TULIP);
        createPotFlowerItemTable(DecoBlocks.POTTED_WEATHERED_COPPER_TULIP);

        dropSelf(DecoBlocks.OXIDIZED_COPPER_TULIP);
        createPotFlowerItemTable(DecoBlocks.POTTED_OXIDIZED_COPPER_TULIP);

        dropSelf(DecoBlocks.WAXED_COPPER_TULIP);
        createPotFlowerItemTable(DecoBlocks.POTTED_WAXED_COPPER_TULIP);

        dropSelf(DecoBlocks.WAXED_EXPOSED_COPPER_TULIP);
        createPotFlowerItemTable(DecoBlocks.POTTED_WAXED_EXPOSED_COPPER_TULIP);

        dropSelf(DecoBlocks.WAXED_WEATHERED_COPPER_TULIP);
        createPotFlowerItemTable(DecoBlocks.POTTED_WAXED_WEATHERED_COPPER_TULIP);

        dropSelf(DecoBlocks.WAXED_OXIDIZED_COPPER_TULIP);
        createPotFlowerItemTable(DecoBlocks.POTTED_WAXED_OXIDIZED_COPPER_TULIP);
